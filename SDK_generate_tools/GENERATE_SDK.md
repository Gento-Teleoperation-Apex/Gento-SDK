...
```text
SDK_CT040600_SDK040600_260803/SDK/00040600/linux_auto_compile.sh
SDK_CT040600_SDK040600_260803/SDK/00040600/C_SDK
```

生成的 deb 默认放在仓库根目录，例如：

```text
gento-sdk_4.6.0_amd64.deb
```
...
```text
dist/gento-sdk_4.6.0_amd64.deb
```
...
```bash
./SDK_generate_tools/generate_sdk.sh --sdk-root SDK_CT040600_SDK040600_260803/SDK/00040600/C_SDK
```

### 指定编译脚本

```bash
./SDK_generate_tools/generate_sdk.sh --compile-script SDK_CT040600_SDK040600_260803/SDK/00040600/linux_auto_compile.sh
```
...
```bash
./SDK_generate_tools/generate_sdk.sh --package-name gento-sdk --package-version 00040600
```
...
并生成类似 `4.6.0` 的 deb 版本号。

如果没有读到这些宏，才会从路径里的 SDK 目录名，例如 `SDK/00040600/C_SDK`，取 `00040600` 作为版本号。
...
如果需要用 `00040600` 作为 deb 版本号：

```bash
./SDK_generate_tools/generate_sdk.sh --package-version 00040600
sudo apt install ./gento-sdk_00040600_amd64.deb
```
