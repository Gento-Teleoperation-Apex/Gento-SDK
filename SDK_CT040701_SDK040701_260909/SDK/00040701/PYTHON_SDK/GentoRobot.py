...
class ToolDynTaskStatus:
    """Tool load identification task status."""
    TASK_IDLE = 0
    TASK_SAMPLING = 1
    TASK_IDENTIFYING = 2
    TASK_DONE = 3
...
class FXRefOriType:
    ...
    FX_REFORI_TYPE_NULL = 0
    FX_REFORI_TYPE_ANYBASE = 1
    FX_REFORI_TYPE_TCP = 2
...
class FXUserFbkType:
    ...
    USER_FBK_ARM0_INTERNAL_CART_D  = 106  # Arm0's Cartesian damping parameters
    ...
    USER_FBK_ARM1_INTERNAL_CART_D  = 206  # Arm1's Cartesian damping parameters
...
class ARM_OUT(Structure):
    ...
    _fields_ = [
        ...
        ("m_ARM_FBK_Joint_GravityTor", c_float * 7),
...
class ARM_IN(Structure):
    ...
    _fields_ = [
        ...
        ("pad", c_byte * 2),
        ("m_ARM_CMD_Ctrl_RefOriType", c_int16),
        ("m_ARM_CMD_Ctrl_RefOri", c_float * 3),
...
class DEVICE_RT(Structure):
    """Device Structures"""
    _fields_ = [
        ("m_DEVICE_FBK_Robot_IMU", c_float * 9),
        ("m_DEVICE_FBK_Agv_IMU", c_float * 9),
        ("m_DEVICE_FBK_Pdo_State", c_int8 * 3),
        ("m_DEVICE_pad", c_int8),
    ]
...
class BODY_OUT(Structure):
    ...
    _fields_ = [
        ...
        ("m_BODY_FBK_Joint_GravityTor", c_float * 6),
    ]
...
class SYSTEM_RT(Structure):
    """User-defined feedback channels (set via FX_L1_System_SetUserFbkType)."""
    _fields_ = [
        ("m_SYSTEM_UserFbk_Type", c_int16 * 4),
        ("m_SYSTEM_UserFbk0", c_float * 8),
        ("m_SYSTEM_UserFbk1", c_float * 8),
        ("m_SYSTEM_UserFbk2", c_float * 8),
        ("m_SYSTEM_UserFbk3", c_float * 8),
    ]
...
class ARM_SET(Structure):
    ...
    _fields_ = [
        ...
        ("m_ARM_Ctrl_PDK",c_float*7),
        ("m_ARM_Ctrl_PDD",c_float*7),
        ("m_ARM_Ctrl_ToolKine", c_float * 6),
        ("m_ARM_Ctrl_ToolDyna", c_float * 10),
        ("m_ARM_SET_SetTag", c_ubyte * 20),
        ("m_ARM_SET_UpdateTag", c_ubyte * 20),
    ]
...
class HAND_IN(Structure):
    """Real-time hand input (rxpdo) data structure (1000 Hz)."""
    _fields_ = [
        ("m_FrameSerial", c_int32),
        ("data", (c_uint8 * 192) * 2),
    ]


class HAND_OUT(Structure):
    """Real-time hand output (txpdo) data structure (1000 Hz)."""
    _fields_ = [
        ("m_FrameSerial", c_int32),
        ("data", (c_uint8 * 512) * 2),
    ]
...
class LoadDynamicPara(Structure):
    """Identified tool load dynamic parameters: mass, center of mass and inertia."""
    _fields_ = [
        ("m", c_double),
        ("r", c_double * 3),
        ("I", c_double * 6),
...
error_dict = {
    ...
    101: "Emergency",
    102: "Servo error",
    103: "Pvt stream broken",
    104: "Request position mode",
    105: "Response position mode",
    106: "Request torque mode",
    107: "Response torque mode",
    108: "Request enable servo",
    109: "Response enable servo",
    110: "Response disable servo",
    111: "Servo state abnormal",
    112: "Slave pdo abnormal",
    113: "Slave state abnormal",
    114: "Bus link down",
    115: "Robot IMU invalid",
    116: "Agv IMU invalid",
}
...
class GentoRobot:
    ...
    def _init_funcs(self):
        ...
        d.FX_L1_Hand_GetData.argtypes = [c_int32, POINTER(c_int32), POINTER(c_ubyte)]
        d.FX_L1_Hand_GetData.restype = c_int32

        d.FX_L1_Hand_SetData.argtypes = [c_int32, POINTER(c_ubyte)]
        d.FX_L1_Hand_SetData.restype = c_int32

        d.FX_L1_Hand_GetType.argtypes = [c_int32, POINTER(c_int32)]
        d.FX_L1_Hand_GetType.restype = c_int32

        # SDO object dictionary access (EtherCAT), one pair per integer width.
        d.FX_L1_Config_SdoWriteInt8.argtypes = [c_int32, c_int32, c_uint32, c_uint32, c_int8]
        d.FX_L1_Config_SdoWriteInt8.restype = c_int32

        d.FX_L1_Config_SdoReadInt8.argtypes = [c_int32, c_int32, c_uint32, c_uint32, POINTER(c_int8)]
        d.FX_L1_Config_SdoReadInt8.restype = c_int32

        d.FX_L1_Config_SdoWriteUInt8.argtypes = [c_int32, c_int32, c_uint32, c_uint32, c_uint8]
        d.FX_L1_Config_SdoWriteUInt8.restype = c_int32

        d.FX_L1_Config_SdoReadUInt8.argtypes = [c_int32, c_int32, c_uint32, c_uint32, POINTER(c_uint8)]
        d.FX_L1_Config_SdoReadUInt8.restype = c_int32

        d.FX_L1_Config_SdoWriteInt16.argtypes = [c_int32, c_int32, c_uint32, c_uint32, c_int16]
        d.FX_L1_Config_SdoWriteInt16.restype = c_int32

        d.FX_L1_Config_SdoReadInt16.argtypes = [c_int32, c_int32, c_uint32, c_uint32, POINTER(c_int16)]
        d.FX_L1_Config_SdoReadInt16.restype = c_int32

        d.FX_L1_Config_SdoWriteUInt16.argtypes = [c_int32, c_int32, c_uint32, c_uint32, c_uint16]
        d.FX_L1_Config_SdoWriteUInt16.restype = c_int32

        d.FX_L1_Config_SdoReadUInt16.argtypes = [c_int32, c_int32, c_uint32, c_uint32, POINTER(c_uint16)]
        d.FX_L1_Config_SdoReadUInt16.restype = c_int32

        d.FX_L1_Config_SdoWriteInt32.argtypes = [c_int32, c_int32, c_uint32, c_uint32, c_int32]
        d.FX_L1_Config_SdoWriteInt32.restype = c_int32

        d.FX_L1_Config_SdoReadInt32.argtypes = [c_int32, c_int32, c_uint32, c_uint32, POINTER(c_int32)]
        d.FX_L1_Config_SdoReadInt32.restype = c_int32

        d.FX_L1_Config_SdoWriteUInt32.argtypes = [c_int32, c_int32, c_uint32, c_uint32, c_uint32]
        d.FX_L1_Config_SdoWriteUInt32.restype = c_int32

        d.FX_L1_Config_SdoReadUInt32.argtypes = [c_int32, c_int32, c_uint32, c_uint32, POINTER(c_uint32)]
        d.FX_L1_Config_SdoReadUInt32.restype = c_int32
        ...
        d.FX_L1_System_SetUserFbkType.argtypes = [c_int32, c_int32]
        d.FX_L1_System_SetUserFbkType.restype = c_int32
        ...
        d.FX_L1_System_RestoreImage.argtypes = []
        d.FX_L1_System_RestoreImage.restype = c_int32

        d.FX_L1_System_SetSN.argtypes = [c_char_p]
        d.FX_L1_System_SetSN.restype = c_int32

        d.FX_L1_System_GetSN.argtypes = [c_char_p]
        d.FX_L1_System_GetSN.restype = c_int32
        ...
        switch_funcs = [
            ...
            "SwitchToMITMode", "SwitchToUserMITMode"
        ]
        for func_name in switch_funcs:
            ...
            elif func_name in ["SwitchToImpJointMode", "SwitchToPDMode"]:
                func.argtypes = [c_int32, c_uint32, c_double, c_double, POINTER(c_double * 7),
                                 POINTER(c_double * 7)]
            elif func_name =="SwitchToImpCartMode":
                func.argtypes = [c_int32, c_uint32, c_uint32, POINTER(c_double * 3), c_double, c_double, POINTER(c_double * 7),
                                 POINTER(c_double * 7)]
            elif func_name == "SwitchToImpForceMode":
                func.argtypes = [c_int32, c_uint32, c_uint32, POINTER(c_double * 3), POINTER(c_double * 5), POINTER(c_double * 5)]
            elif func_name in ["SwitchToDragCartX", "SwitchToDragCartY",
                               "SwitchToDragCartZ", "SwitchToDragCartR", ]:
                func.argtypes = [c_int32, c_uint32, c_uint32, POINTER(c_double * 3), POINTER(c_double * 7), POINTER(c_double * 7)]
            elif func_name in ["SwitchToDragJoint", "SwitchToMITMode"]:
                func.argtypes = [c_int32, c_uint32, POINTER(c_double * 7), POINTER(c_double * 7)]
            elif func_name == "SwitchToUserMITMode":
                func.argtypes = [c_int32, c_uint32, POINTER(c_double * 7), POINTER(c_double * 7),
                                 POINTER(c_double * 7), POINTER(c_double * 7), POINTER(c_double * 7)]
        ...
        d.FX_L1_Config_GetPDCmdCycleTime.argtypes = [POINTER(c_int)]
        d.FX_L1_Config_GetPDCmdCycleTime.restype = c_int

        d.FX_L1_Config_SetInterferenceEnable.argtypes = [c_char_p, c_char_p, c_char_p, c_char_p, c_char_p]
        d.FX_L1_Config_SetInterferenceEnable.restype = c_int32

        d.FX_L1_Config_SetInterferenceDisable.argtypes = []
        d.FX_L1_Config_SetInterferenceDisable.restype = c_int32
        ...
        d.FX_L1_Runtime_SetJointMITCmd.argtypes = [c_uint32, c_int32, POINTER(c_double * 7), POINTER(c_double * 7), 
                                                   POINTER(c_double * 7), POINTER(c_double * 7), POINTER(c_double * 7)]
        d.FX_L1_Runtime_SetJointMITCmd.restype = c_int32
        ...
        d.FX_L1_Runtime_SetRefOri.argtypes = [c_uint32, c_int32, c_int32, POINTER(c_double * 3)]
        d.FX_L1_Runtime_SetRefOri.restype = c_int32
        ...
        d.FX_L1_Runtime_SetPDP.argtypes = [c_uint32, c_int32, POINTER(c_double * 7)]
        d.FX_L1_Runtime_SetPDP.restype = c_int32

        d.FX_L1_Runtime_SetPDD.argtypes = [c_uint32, c_int32, POINTER(c_double * 7)]
        d.FX_L1_Runtime_SetPDD.restype = c_int32

        d.FX_L1_Runtime_SetPD.argtypes = [c_uint32, c_int32, POINTER(c_double * 7), POINTER(c_double * 7)]
        d.FX_L1_Runtime_SetPD.restype = c_int32
        ...
        # Luna Body kinematics
        d.FX_L1_Kinematics_LunaBodyInit_ByIniConfig.argtypes = [c_void_p]
        d.FX_L1_Kinematics_LunaBodyInit_ByIniConfig.restype = c_int32

        d.FX_L1_Kinematics_LunaBodyInit_ByInputParams.argtypes = [
            c_void_p,
            (c_double * 4) * 6,
            c_double,
            c_double * 6,
        ...
        d.FX_L1_Kinematics_LunaBodyInit_ByInputParams.restype = c_int32

        d.FX_L1_Kinematics_LunaBodyForwardKinematics.argtypes = [
            c_void_p,
            c_double * 6,
            (c_double * 4) * 4,
            (c_double * 4) * 4,
        ]
        d.FX_L1_Kinematics_LunaBodyForwardKinematics.restype = c_int32

        d.FX_L1_Kinematics_LunaBodyInverseKinematics.argtypes = [
            c_void_p,
            (c_double * 4) * 4,
            (c_double * 4) * 4,
            c_double * 6,
        ...
        d.FX_L1_Kinematics_LunaBodyInverseKinematics.restype = c_int32
        ...
        d.FX_Interf_Create.argtypes = []
        d.FX_Interf_Create.restype = c_void_p

        d.FX_Interf_Destroy.argtypes = [c_void_p]
        d.FX_Interf_Destroy.restype = None

        d.FX_Interf_Init.argtypes = [c_void_p, c_char_p, c_char_p, c_char_p, c_char_p, c_char_p]
        d.FX_Interf_Init.restype = c_int32

        d.FX_Interf_UpdateCord.argtypes = [c_void_p, c_long, POINTER(c_double)]
        d.FX_Interf_UpdateCord.restype = c_int32

        d.FX_Interf_UpdateConvex.argtypes = [c_void_p]
        d.FX_Interf_UpdateConvex.restype = c_int32

        d.FX_Interf_CalInterfDistance.argtypes = [c_void_p]
        d.FX_Interf_CalInterfDistance.restype = c_int32

        d.FX_Interf_GetCoM.argtypes = [c_void_p, POINTER(c_double * 3)]
        d.FX_Interf_GetCoM.restype = c_int32

        d.FX_Interf_GetInputNum.argtypes = [c_void_p, POINTER(c_long)]
        d.FX_Interf_GetInputNum.restype = c_int32

        d.FX_Interf_GetInterfNum.argtypes = [c_void_p, POINTER(c_long)]
        d.FX_Interf_GetInterfNum.restype = c_int32

        d.FX_Interf_GetMass.argtypes = [c_void_p, POINTER(c_double)]
        d.FX_Interf_GetMass.restype = c_int32

        d.FX_Interf_GetMinSpan.argtypes = [c_void_p, POINTER(c_double)]
        d.FX_Interf_GetMinSpan.restype = c_int32

        d.FX_Interf_GetInterfSpan.argtypes = [c_void_p, c_long, POINTER(c_double)]
        d.FX_Interf_GetInterfSpan.restype = c_int32

        # Tool load identification (ToolDynaIdent): sampling and identification are decoupled
        d.FX_ToolDyn_Start_Sampling.argtypes = [c_int32, c_int32, c_char_p]
        d.FX_ToolDyn_Start_Sampling.restype = c_void_p

        d.FX_ToolDyn_Get_Sampling_Status.argtypes = [c_void_p, POINTER(c_int32), POINTER(c_int32), POINTER(c_int32)]
        d.FX_ToolDyn_Get_Sampling_Status.restype = c_int32

        d.FX_ToolDyn_Stop_Sampling.argtypes = [c_void_p]
        d.FX_ToolDyn_Stop_Sampling.restype = c_int32

        d.FX_ToolDyn_Destroy_Sampling.argtypes = [c_void_p]
        d.FX_ToolDyn_Destroy_Sampling.restype = c_int32

        d.FX_ToolDyn_Run_Load_Identification.argtypes = [c_int32, POINTER(c_int32), POINTER(LoadDynamicPara), c_char_p]
        d.FX_ToolDyn_Run_Load_Identification.restype = c_int32
    ...
    def hand_get_data(self, obj_type: int) -> Tuple[int, int, bytes]:
        """Read 512 bytes of hand data from a hand (replaces FX_L1_Hand_GetIn/Out).

        @param obj_type: FXObjType.OBJ_ARM0 (hand 0) or FXObjType.OBJ_ARM1 (hand 1).
        @return: Tuple (ret_code, serial, data) where data is 512 bytes.
        """
        serial = c_int32(0)
        buf = (c_ubyte * 512)()
        ret = self.dll.FX_L1_Hand_GetData(obj_type, byref(serial), buf)
        return ret, serial.value, bytes(buf)

    def hand_set_data(self, obj_type: int, hex_data) -> int:
        """Send 512 bytes of hand data to a hand (replaces the txpdo write).

        @param obj_type: FXObjType.OBJ_ARM0 (hand 0) or FXObjType.OBJ_ARM1 (hand 1).
        @param hex_data: Hex string (e.g. 'FF 01 02' or 'FF0102') or bytes-like;
               converted to bytes and zero-padded / truncated to 512 bytes.
        @return: 0 on success, negative error code otherwise.
        @raise ValueError: If a hex string is malformed.
        """
        if isinstance(hex_data, str):
            hs = hex_data.replace(' ', '').replace('\n', '').replace('\r', '').replace('\t', '')
        ...
        for i in range(len(src)):
            buf[i] = src[i]
        return self.dll.FX_L1_Hand_SetData(obj_type, buf)

    def hand_get_type(self, obj_type: int) -> Tuple[int, str]:
        """Read the type of a hand.

        @param obj_type: FXObjType.OBJ_ARM0 (hand 0) or FXObjType.OBJ_ARM1 (hand 1).
        @return: Tuple (ret_code, hand_type_str) where hand_type_str is the FXHandType
                 value mapped to its name, e.g. "FX_HAND_TJDH_6"; "Unknown (n)" if the
                 raw value is not a known FXHandType.
        """
        hand_type = c_int32(0)
        ret = self.dll.FX_L1_Hand_GetType(obj_type, byref(hand_type))
        names = {v: k for k, v in vars(FXHandType).items()
                 if not k.startswith('_') and isinstance(v, int)}
        return ret, names.get(hand_type.value, f"Unknown ({hand_type.value})")

    def get_rt_dict(self) -> dict:
        """Return a dictionary containing all real-time feedback data.

        @return: Dictionary with keys: frame_serial, base_gyro, pdo_state, head,
                 arms, body, lift, system_user_fbk.
        ...
        data = {
            ...
            "robot_imu":[self._round_float(rt.m_DEVICE.m_DEVICE_FBK_Robot_IMU[i]) for i in range(9)],
            "agv_imu":[self._round_float(rt.m_DEVICE.m_DEVICE_FBK_Agv_IMU[i]) for i in range(9)],
            "pdo_state": [rt.m_DEVICE.m_DEVICE_FBK_Pdo_State[i] for i in range(3)],
            "head": {
                "state": {
            ...
            "body": {
                ...
                "fb_gravity_torque":[self._round_float(rt.m_BODY.m_BODY_OUT.m_BODY_FBK_Joint_GravityTor[i]) for i in range(6)],
            },
            "lift": {
                "state": {
            ...
            "system_user_fbk": {
                "types": [rt.m_SYSTEM.m_SYSTEM_UserFbk_Type[i] for i in range(4)],
                "chn": [
                    [self._round_float(rt.m_SYSTEM.m_SYSTEM_UserFbk0[i]) for i in range(8)],
                    [self._round_float(rt.m_SYSTEM.m_SYSTEM_UserFbk1[i]) for i in range(8)],
                    [self._round_float(rt.m_SYSTEM.m_SYSTEM_UserFbk2[i]) for i in range(8)],
                    [self._round_float(rt.m_SYSTEM.m_SYSTEM_UserFbk3[i]) for i in range(8)],
                ],
            },
        }
        for arm_idx in range(2):
            ...
            arm_data = {
                ...
                "cmd": {
                    ...
                    "pad":[self._round_float(arm.m_ARM_IN.pad[i]) for i in range(2)],
                    "ref_orientation_type":arm.m_ARM_IN.m_ARM_CMD_Ctrl_RefOriType,
                    "ref_orientation": [self._round_float(arm.m_ARM_IN.m_ARM_CMD_Ctrl_RefOri[i]) for i in range(3)],
                    "tag": arm.m_ARM_IN.m_ARM_CMD_Tag,
                    "pd_serial": arm.m_ARM_IN.m_ARM_CMD_PD_Serial,
                ...
                "fb": {
                    ...
                    "fb_ext_torque": [self._round_float(arm.m_ARM_OUT.m_ARM_FBK_Joint_ExternalTorEst[i]) for i in
                                      range(7)],
                    "fb_gravity_torque": [self._round_float(arm.m_ARM_OUT.m_ARM_FBK_Joint_GravityTor[i]) for i in
                                      range(7)],
    ...
    def get_sg_dict(self) -> dict:
        ...
        sg = self.sg
        data = {
            "frame_serial": sg.m_SG_FrameSerial,
            "head": {
                "set": {
            ...
            "body": {
                ...
                "get": {
                    ...
                    "low_speed_flag": sg.m_BODY.m_BODY_GET.m_BODY_FBK_LowSpdFlag,
                    "traj_state": sg.m_BODY.m_BODY_GET.m_BODY_FBK_TrajState,
                    "pd_cmd_quanlity":sg.m_BODY.m_BODY_GET.m_BODY_FBK_PD_CmdQuality,
                    "pad":[self._round_float(sg.m_BODY.m_BODY_GET.m_BODY_pad[i]) for i in range(3)],
        ...
        for arm_idx in range(2):
            ...
            arm_data = {
                "set": {
                    ...
                    "pd_k": [self._round_float(arm_sg.m_ARM_SET.m_ARM_Ctrl_PDK[i]) for i in range(7)],
                    "pd_d": [self._round_float(arm_sg.m_ARM_SET.m_ARM_Ctrl_PDD[i]) for i in range(7)],
                    ...
                    "set_tags": [arm_sg.m_ARM_SET.m_ARM_SET_SetTag[i] for i in range(20)],
                    "update_tags": [arm_sg.m_ARM_SET.m_ARM_SET_UpdateTag[i] for i in range(20)],
                },
                "get": {
    ...
    def get_hand_in_dict(self) -> dict:
        """Return hand input data read via FX_L1_Hand_GetData for both hands.

        @return: Dictionary {"frame_serial": serial0, "data": [hand0(512), hand1(512)]}.
        @note: Returns {"error": "Robot not connected"} if not connected.
        """
        return self._hand_data_dict()

    def get_hand_out_dict(self) -> dict:
        """Return hand output data.

        The new Hand API (FX_L1_Hand_GetData/SetData) unifies the rxpdo/txpdo read
        into a single 512-byte read per hand, so this returns the same hand data as
        get_hand_in_dict. Use hand_set_data() to write to a hand.

        @return: Same shape as get_hand_in_dict.
        """
        return self._hand_data_dict()

    def _hand_data_dict(self) -> dict:
        if not self._connected:
            return {"error": "Robot not connected"}
        serial0, datas = 0, [None, None]
        for i, obj in enumerate((FXObjType.OBJ_ARM0, FXObjType.OBJ_ARM1)):
            ret, serial, data = self.hand_get_data(obj)
            if i == 0:
                serial0 = serial
            datas[i] = data
        return {"frame_serial": serial0, "data": datas}
    ...
    def system_set_user_fbk_type(self, chn_id: int, fbk_type: int) -> int:
        """Configure a user-defined feedback channel source.

        @param chn_id: Feedback channel index (0-3); maps to m_SYSTEM_UserFbk0..3.
        @param fbk_type: Source type (FXUserFbkType), e.g. USER_FBK_ARM0_INTERNAL_FFDTOR.
        @return: 0 on success, negative error code otherwise.
        """
        return self.dll.FX_L1_System_SetUserFbkType(chn_id, fbk_type)
    ...
    def set_system_sn(self, serial: str) -> int:
        """Set the robot serial number.

        @param serial: Serial number string (max 29 characters; must fit in a 30-byte buffer).
        @return: 0 on success, negative error code otherwise.
        @raise ValueError: If serial is empty or longer than 29 characters.
        """
        if not serial:
            raise ValueError("serial must not be empty")
        if len(serial) > 29:
            raise ValueError("serial must be at most 29 characters")
        buf = create_string_buffer(serial.encode('utf-8'), 30)
        return self.dll.FX_L1_System_SetSN(buf)

    def get_system_sn(self) -> tuple:
        """Get the robot serial number.

        @return: Tuple (return_code, serial_string). serial_string is empty on failure.
        """
        buf = create_string_buffer(30)
        ret = self.dll.FX_L1_System_GetSN(buf)
        if ret == 0:
            return ret, buf.value.decode('utf-8')
        return ret, ''

    def system_restore_image(self) -> int:
        """Restore the system image from a backup.

        @return: State code (see state_map).
        """
        return self.dll.FX_L1_System_RestoreImage()
    ...
    def switch_to_imp_cart_mode(self, obj_type: int, timeout: int, ref_ori_type:int, ref_ori: List[float], vel: float, acc: float,
                                k: List[float], d: List[float]) -> int:
        """Switch to Cartesian impedance control mode.

        @param obj_type: Object type (FXObjType).
        @param timeout: Timeout in milliseconds.
        @param ref_ori_type: Reference orientation type(FXRefOriType).
        @param ref_ori: Reference orientation in euler angle A/B/C.
        @param vel: Velocity ratio (1-100 %).
        @param acc: Acceleration ratio (1-100 %).
        ...
        @return: 0 on success, negative error code otherwise.
        """
        ref_ori_arr=(c_double * 3)(*ref_ori)
        vel = max(1, min(vel, 100))
        acc = max(1, min(acc, 100))
        k = [max(0, v) for v in k]
        d = [max(0, v) for v in d]
        k_arr = (c_double * 7)(*k)
        d_arr = (c_double * 7)(*d)
        return self.dll.FX_L1_State_SwitchToImpCartMode(obj_type, timeout,ref_ori_type,ref_ori_arr, vel, acc, k_arr, d_arr)
    ...
    def switch_to_imp_force_mode(self, obj_type: int, timeout: int, ref_ori_type:int, ref_ori: List[float],
        ...
        return self.dll.FX_L1_State_SwitchToImpForceMode(obj_type, timeout, ref_ori_type, ref_ori_arr, f_arr, t_arr)
    ...
    def switch_to_drag_cart_x(self, obj_type: int, timeout: int, ref_ori_type:int, ref_ori: List[float], k: List[float], d: List[float]) -> int:
        ...
        k_arr = (c_double * 7)(*k)
        d_arr = (c_double * 7)(*d)
        return self.dll.FX_L1_State_SwitchToDragCartX(obj_type, timeout, ref_ori_type, ref_ori_arr, k_arr, d_arr)

    def switch_to_drag_cart_y(self, obj_type: int, timeout: int, ref_ori_type:int, ref_ori: List[float], k: List[float], d: List[float]) -> int:
        ...
        k_arr = (c_double * 7)(*k)
        d_arr = (c_double * 7)(*d)
        return self.dll.FX_L1_State_SwitchToDragCartY(obj_type, timeout, ref_ori_type, ref_ori_arr, k_arr, d_arr)

    def switch_to_drag_cart_z(self, obj_type: int, timeout: int, ref_ori_type:int, ref_ori: List[float], k: List[float], d: List[float]) -> int:
        ...
        k_arr = (c_double * 7)(*k)
        d_arr = (c_double * 7)(*d)
        return self.dll.FX_L1_State_SwitchToDragCartZ(obj_type, timeout, ref_ori_type, ref_ori_arr, k_arr, d_arr)

    def switch_to_drag_cart_r(self, obj_type: int, timeout: int, ref_ori_type:int, ref_ori: List[float], k: List[float], d: List[float]) -> int:
        ...
        k_arr = (c_double * 7)(*k)
        d_arr = (c_double * 7)(*d)
        return self.dll.FX_L1_State_SwitchToDragCartR(obj_type, timeout, ref_ori_type, ref_ori_arr, k_arr, d_arr)
    ...
    def switch_to_mit_mode(self, obj_type: int, timeout: int, k: List[float], d: List[float]) -> int:
        """Switch to MIT torque-control mode.

        Transitions the joint controller into MIT mode, where the output torque is computed as
        tau = Kp*(q_des - q) + Kd*(qdot_des - qdot) + tau_ff.

        @param obj_type: Object type (FXObjType) – typically an arm.
        @param timeout: Timeout in milliseconds.
        @param k: Position gain (stiffness) vector Kp for each of the 7 joints [Nm/deg] (>=0).
        @param d: Velocity gain (damping) vector Kd for each of the 7 joints [Nm·s/deg] (>=0).
        @return: 0 on success, negative error code otherwise.
        @raise ValueError: If k or d does not have exactly 7 elements.
        @warning Sudden mode transitions without proper pre-positioning may cause abrupt
                 torque changes. Verify mechanical limits and safety constraints before use.
        """
        if len(k) != 7:
        ...
        k_arr = (c_double * 7)(*k)
        d_arr = (c_double * 7)(*d)
        return self.dll.FX_L1_State_SwitchToMITMode(obj_type, timeout, k_arr, d_arr)

    def switch_to_user_mit_mode(self, obj_type: int, timeout: int,
                                pos: List[float], vel: List[float], tor: List[float],
                                k: List[float], d: List[float]) -> int:
        """Switch to user-defined MIT torque-control mode with initial references.

        Same MIT control law as switch_to_mit_mode(), but allows the initial desired joint
        position, velocity, and feedforward torque references to be set at mode entry:
        tau = Kp*(q_des - q) + Kd*(qdot_des - qdot) + tau_ff.

        @param obj_type: Object type (FXObjType) – typically an arm.
        @param timeout: Timeout in milliseconds.
        @param pos: Desired joint position vector for each of the 7 joints [deg].
        @param vel: Desired joint velocity vector for each of the 7 joints [deg/s].
        @param tor: Feedforward torque vector for each of the 7 joints [Nm].
        @param k: Position gain (stiffness) vector Kp for each of the 7 joints [Nm/deg] (>=0).
        @param d: Velocity gain (damping) vector Kd for each of the 7 joints [Nm·s/deg] (>=0).
        @return: 0 on success, negative error code otherwise.
        @raise ValueError: If any of pos/vel/tor/k/d does not have exactly 7 elements.
        @warning Sudden mode transitions without proper pre-positioning may cause abrupt
                 torque changes. Verify mechanical limits and safety constraints before use.
        """
        for name, arr in (("pos", pos), ("vel", vel), ("tor", tor), ("k", k), ("d", d)):
            if len(arr) != 7:
                raise ValueError(f"{name} must have 7 elements")
        k = [max(0, v) for v in k]
        d = [max(0, v) for v in d]
        pos_arr = (c_double * 7)(*pos)
        vel_arr = (c_double * 7)(*vel)
        tor_arr = (c_double * 7)(*tor)
        k_arr = (c_double * 7)(*k)
        d_arr = (c_double * 7)(*d)
        return self.dll.FX_L1_State_SwitchToUserMITMode(obj_type, timeout,
                                                         pos_arr, vel_arr, tor_arr, k_arr, d_arr)
    ...
    # ==================== Terminal ====================
    def terminal_clear(self, obj_type: int) -> int:
        """Clear terminal data buffer.

        @param obj_type: Object type (FXObjType.OBJ_ARM0 / OBJ_ARM1).
        @return: 0 on success, negative error code otherwise.
        """
        return self.dll.FX_L1_Terminal_ClearData(obj_type)

    def terminal_get(self, obj_type: int, timeout: int = 1000) -> Tuple[int, bytes, int]:
        ...
        data = (c_ubyte * 64)()
        recv_time = c_uint32()
        n = self.dll.FX_L1_Terminal_GetData(obj_type, timeout, byref(output_chn), data, byref(recv_time))
        if n <= 0:
            return (0, b'', 0)
        return (output_chn.value, bytes(data[:n]), recv_time.value)

    def terminal_set(self, obj_type: int, chn_type: int, data, timeout: int = 1000) -> Tuple[int, int]:
        """Write data to the terminal.

        @param obj_type: Object type (FXObjType.OBJ_ARM0 / OBJ_ARM1).
        @param chn_type: Channel type (FXChnType).
        @param data: Data as bytes or hex string (e.g., 'FF 01 02').a
        @param timeout: Timeout in milliseconds.
        ...
        send_time = c_uint32()
        ret = self.dll.FX_L1_Terminal_SetData(obj_type, chn_type, timeout, buf, data_len, byref(send_time))
    ...
    def config_get_pd_cmd_cycle_time(self) -> Tuple[int, int]:
        """Get the current command cycle time for PD control.

        @return: Tuple (return_code, cycle_time_ms). cycle_time_ms is the command cycle
                 time in milliseconds. On failure, cycle_time_ms is 0.
        """
        cycle_time = c_int(0)
        ret = self.dll.FX_L1_Config_GetPDCmdCycleTime(byref(cycle_time))
        return ret, cycle_time.value

    def config_set_interference_enable(self, cord_def: str, cal_link_def: str,
                                       input_def: str, convex_def: str,
                                       ic_def: str) -> int:
        """Enable the interference (collision) check module with specified configuration files.

        Activates collision/interference detection inside the subsequent motion
        planning and running cycle, loading definition files for coordinate
        system, calibrated link, input parameters, convex collision geometry
        and inertial parameters.

        @param cord_def: Path of the coordinate definition file.
        @param cal_link_def: Path of the calibrated link definition file.
        @param input_def: Path of the interference calculation input definition file.
        @param convex_def: Path of the convex collision geometry definition file.
        @param ic_def: Path of the inertial characteristic definition file.
        @return: 0 on success, negative error code otherwise.
        """
        return self.dll.FX_L1_Config_SetInterferenceEnable(
            cord_def.encode('utf-8'), cal_link_def.encode('utf-8'),
            input_def.encode('utf-8'), convex_def.encode('utf-8'),
            ic_def.encode('utf-8'))

    def config_set_interference_disable(self) -> int:
        """Disable the interference (collision) check module.

        Deactivates collision/interference detection and clears loaded
        interference configuration.

        @return: 0 on success, negative error code otherwise.
        """
        return self.dll.FX_L1_Config_SetInterferenceDisable()

    # ==================== EtherCAT SDO access ====================
    @staticmethod
    def _sdo_parse_addr(object_index, object_subindex) -> Tuple[int, int]:
        """Normalize SDO object address arguments.

        Accepts int, or hex string in '1A00' / '0x1A00' form (no 0x prefix means
        hex, matching EtherCAT convention).

        @return: Tuple (object_index, object_subindex) as ints.
        @raise ValueError: If a string is not valid hex or an int is out of range.
        """
        def parse(v, bits, name):
            if isinstance(v, str):
                s = v.strip().lower()
                if s.startswith('0x'):
                    s = s[2:]
                if not s or any(c not in '0123456789abcdef' for c in s):
                    raise ValueError(f"{name} '{v}' is not a valid hex string")
                val = int(s, 16)
            else:
                val = int(v)
            if not 0 <= val < (1 << bits):
                raise ValueError(f"{name} out of hex range [0x0, 0x{(1 << bits) - 1:X}]")
            return val
        return parse(object_index, 16, "object_index"), parse(object_subindex, 8, "object_subindex")

    def config_sdo_write_int8(self, master_id: int, slave_pos: int,
                              object_index, object_subindex, object_data: int) -> int:
        """Write an 8-bit signed integer (INT8) to an EtherCAT SDO object.

        @param master_id: Master (segment) identifier, 0~2.
        @param slave_pos: Slave position on the bus, 0~15.
        @param object_index: Object dictionary index, hex string ('1A00' or '0x1A00') or int.
        @param object_subindex: Sub-index of the target object, hex string ('0A' or '0x0A') or int.
        @param object_data: Value to be written.
        @return: 0 on success, negative error code otherwise.
        """
        object_index, object_subindex = self._sdo_parse_addr(object_index, object_subindex)
        return self.dll.FX_L1_Config_SdoWriteInt8(master_id, slave_pos, object_index, object_subindex, object_data)

    def config_sdo_read_int8(self, master_id: int, slave_pos: int,
                             object_index, object_subindex) -> Tuple[int, int]:
        """Read an 8-bit signed integer (INT8) from an EtherCAT SDO object.

        @param master_id: Master (segment) identifier, 0~2.
        @param slave_pos: Slave position on the bus, 0~15.
        @param object_index: Object dictionary index, hex string ('1A00' or '0x1A00') or int.
        @param object_subindex: Sub-index of the target object, hex string ('0A' or '0x0A') or int.
        @return: Tuple (ret_code, value). value is 0 on failure.
        """
        object_index, object_subindex = self._sdo_parse_addr(object_index, object_subindex)
        value = c_int8(0)
        ret = self.dll.FX_L1_Config_SdoReadInt8(master_id, slave_pos, object_index, object_subindex, byref(value))
        return ret, value.value

    def config_sdo_write_uint8(self, master_id: int, slave_pos: int,
                               object_index, object_subindex, object_data: int) -> int:
        """Write an 8-bit unsigned integer (UINT8) to an EtherCAT SDO object.
        ...
        """
        object_index, object_subindex = self._sdo_parse_addr(object_index, object_subindex)
        return self.dll.FX_L1_Config_SdoWriteUInt8(master_id, slave_pos, object_index, object_subindex, object_data)

    def config_sdo_read_uint8(self, master_id: int, slave_pos: int,
                              object_index, object_subindex) -> Tuple[int, int]:
        """Read an 8-bit unsigned integer (UINT8) from an EtherCAT SDO object.
        ...
        object_index, object_subindex = self._sdo_parse_addr(object_index, object_subindex)
        value = c_uint8(0)
        ret = self.dll.FX_L1_Config_SdoReadUInt8(master_id, slave_pos, object_index, object_subindex, byref(value))
        return ret, value.value

    def config_sdo_write_int16(self, master_id: int, slave_pos: int,
                               object_index, object_subindex, object_data: int) -> int:
        """Write a 16-bit signed integer (INT16) to an EtherCAT SDO object.
        ...
        """
        object_index, object_subindex = self._sdo_parse_addr(object_index, object_subindex)
        return self.dll.FX_L1_Config_SdoWriteInt16(master_id, slave_pos, object_index, object_subindex, object_data)

    def config_sdo_read_int16(self, master_id: int, slave_pos: int,
                              object_index, object_subindex) -> Tuple[int, int]:
        """Read a 16-bit signed integer (INT16) from an EtherCAT SDO object.
        ...
        object_index, object_subindex = self._sdo_parse_addr(object_index, object_subindex)
        value = c_int16(0)
        ret = self.dll.FX_L1_Config_SdoReadInt16(master_id, slave_pos, object_index, object_subindex, byref(value))
        return ret, value.value

    def config_sdo_write_uint16(self, master_id: int, slave_pos: int,
                                object_index, object_subindex, object_data: int) -> int:
        """Write a 16-bit unsigned integer (UINT16) to an EtherCAT SDO object.
        ...
        """
        object_index, object_subindex = self._sdo_parse_addr(object_index, object_subindex)
        return self.dll.FX_L1_Config_SdoWriteUInt16(master_id, slave_pos, object_index, object_subindex, object_data)

    def config_sdo_read_uint16(self, master_id: int, slave_pos: int,
                               object_index, object_subindex) -> Tuple[int, int]:
        """Read a 16-bit unsigned integer (UINT16) from an EtherCAT SDO object.
        ...
        object_index, object_subindex = self._sdo_parse_addr(object_index, object_subindex)
        value = c_uint16(0)
        ret = self.dll.FX_L1_Config_SdoReadUInt16(master_id, slave_pos, object_index, object_subindex, byref(value))
        return ret, value.value

    def config_sdo_write_int32(self, master_id: int, slave_pos: int,
                               object_index, object_subindex, object_data: int) -> int:
        """Write a 32-bit signed integer (INT32) to an EtherCAT SDO object.
        ...
        """
        object_index, object_subindex = self._sdo_parse_addr(object_index, object_subindex)
        return self.dll.FX_L1_Config_SdoWriteInt32(master_id, slave_pos, object_index, object_subindex, object_data)

    def config_sdo_read_int32(self, master_id: int, slave_pos: int,
                              object_index, object_subindex) -> Tuple[int, int]:
        """Read a 32-bit signed integer (INT32) from an EtherCAT SDO object.
        ...
        object_index, object_subindex = self._sdo_parse_addr(object_index, object_subindex)
        value = c_int32(0)
        ret = self.dll.FX_L1_Config_SdoReadInt32(master_id, slave_pos, object_index, object_subindex, byref(value))
        return ret, value.value

    def config_sdo_write_uint32(self, master_id: int, slave_pos: int,
                                object_index, object_subindex, object_data: int) -> int:
        """Write a 32-bit unsigned integer (UINT32) to an EtherCAT SDO object.
        ...
        """
        object_index, object_subindex = self._sdo_parse_addr(object_index, object_subindex)
        return self.dll.FX_L1_Config_SdoWriteUInt32(master_id, slave_pos, object_index, object_subindex, object_data)

    def config_sdo_read_uint32(self, master_id: int, slave_pos: int,
                               object_index, object_subindex) -> Tuple[int, int]:
        """Read a 32-bit unsigned integer (UINT32) from an EtherCAT SDO object.
        ...
        object_index, object_subindex = self._sdo_parse_addr(object_index, object_subindex)
        value = c_uint32(0)
        ret = self.dll.FX_L1_Config_SdoReadUInt32(master_id, slave_pos, object_index, object_subindex, byref(value))
        return ret, value.value
    ...
    def runtime_set_joint_pos_pd_cmd(self, obj_type: int, positions: List[float]) -> int:
        ...
        @param positions: List of 7 target joint positions [°].
        @return: 0 on success, negative error code otherwise.
    ...
    def runtime_set_joint_mit_cmd(self, obj_type: int, pos_cmd:List[float], vel_cmd:List[float], tor_cmd:List[float], k_cmd:List[float], d_cmd:List[float]) -> int:
        """Update joint control commands in MIT Mode during runtime
        Sets the real-time control references for all 7 joints when the controller is
        operating in User MIT Mode. This function overwrites the previous control
        setpoints and gains without requiring a state transition. The controller applies
        the MIT control law:
        @f$ \\tau = K_p (q_{cmd} - q) + K_d (\\dot{q}_{cmd} - \\dot{q}) + \\tau_{ff} @f$,
        where the feedback terms are computed internally based on current joint states.

        @param obj_type: Object type (FXObjType) – typically an arm.
        @param pos_cmd: Desired joint position vector for each of the 7 joints [°].
        @param vel_cmd: Desired joint velocity vector for each of the 7 joints [°/s].
        @param tor_cmd: Feedforward torque vector for each of the 7 joints [Nm].
        @param k_cmd: Position gain (stiffness) vector K_p for each of the 7 joints [Nm/°].
        @param d_cmd: Velocity gain (damping) vector K_d for each of the 7 joints [Nm·s/°].
        @return: 0 on success, negative error code otherwise.
        @raise ValueError: If pos_cmd/vel_cmd/tor_cmd/k_cmd/d_cmd does not have exactly 7 elements.
        """
        if len(pos_cmd)!=7:
            raise ValueError("pos_cmd must have 7 elements")
        if len(vel_cmd)!=7:
            raise ValueError("vel_cmd must have 7 elements")
        if len(tor_cmd)!=7:
            raise ValueError("tor_cmd must have 7 elements")
        if len(k_cmd)!=7:
            raise ValueError("k_cmd must have 7 elements")
        if len(d_cmd)!=7:
            raise ValueError("d_cmd must have 7 elements")
        pos_arr = (c_double * 7)(*pos_cmd)
        vel_arr = (c_double * 7)(*vel_cmd)
        tor_arr = (c_double * 7)(*tor_cmd)
        k_arr = (c_double * 7)(*k_cmd)
        d_arr = (c_double * 7)(*d_cmd)
        return self.dll.FX_L1_Runtime_SetJointMITCmd(self._thread_id, obj_type, pos_arr,vel_arr,tor_arr,k_arr,d_arr)
    ...
    def runtime_set_ref_ori(self, obj_type: int, ref_ori_type: int, ref_ori: List[float]):
        """Set the reference orientation for a runtime-controlled object.
        
        @param obj_type: Object type (FXObjType) – typically an arm.
        @param ref_ori_type: Representation type of the reference orientation(FXRefOriType).
        @param ref_ori:  Array containing the reference orientation data - For Euler angles (RPY): [roll, pitch, yaw] (degree).
        @return: 0 on success, negative error code otherwise.
        @raise ValueError: If ref_ori does not have exactly 3 elements.

        FX_L1_Runtime_SetRefOri(unsigned int thread_id, FXObjType obj_type, FXRefOriType ref_ori_type, double ref_ori[3]);
        """
        if len(ref_ori) != 3:
            raise ValueError("ref_ori must have 3 elements")
        arr = (c_double * 3)(*ref_ori)
        return self.dll.FX_L1_Runtime_SetRefOri(self._thread_id, obj_type, ref_ori_type, arr)
    ...
    def runtime_set_body_pdp(self, obj_type: int, p: List[float]) -> int:
        """Set body proportional (P) gains.

        @param obj_type: Object type (FXObjType)
        @param p: List of 7 proportional gains (>=0).
        @return: 0 on success, negative error code otherwise.
        @raise ValueError: If p does not have exactly 7 elements.
        """
        if len(p) != 7:
            raise ValueError("p must have 7 elements")
        p = [max(0, v) for v in p]
        arr = (c_double * 7)(*p)
        return self.dll.FX_L1_Runtime_SetPDP(self._thread_id, obj_type, arr)

    def runtime_set_pdd(self, obj_type: int, d: List[float]) -> int:
        """Set body derivative (D) gains.

        @param obj_type: Object type (FXObjType)
        @param d: List of 7 derivative gains (>=0).
        @return: 0 on success, negative error code otherwise.
        @raise ValueError: If d does not have exactly 7 elements.
        """
        if len(d) != 7:
        ...
        d = [max(0, v) for v in d]
        arr = (c_double * 7)(*d)
        return self.dll.FX_L1_Runtime_SetPDD(self._thread_id, obj_type, arr)

    def runtime_set_pd(self, obj_type: int, p: List[float], d: List[float]) -> int:
        """Set both proportional and derivative gains.

        @param obj_type: Object type (FXObjType)
        @param p: List of 7 proportional gains (>=0).
        @param d: List of 7 derivative gains (>=0).
        @return: 0 on success, negative error code otherwise.
        @raise ValueError: If p or d does not have exactly 7 elements.
        """
        if len(p) != 7 or len(d) != 7:
            raise ValueError("p and d must have 7 elements each")
        p = [max(0, v) for v in p]
        d = [max(0, v) for v in d]
        p_arr = (c_double * 7)(*p)
        d_arr = (c_double * 7)(*d)
        return self.dll.FX_L1_Runtime_SetPD(self._thread_id, obj_type, p_arr, d_arr)
    ...
    # ---------- Luna body kinematics ----------
    def luna_body_init_by_config(self) -> int:
        """Initialize the Luna body kinematics environment using the default ini
        configuration. The robot must be connected.

        @return: 0 on success, negative error code otherwise.
        """
        self._ensure_kin_handle()
        return self.dll.FX_L1_Kinematics_LunaBodyInit_ByIniConfig(self._kin_handle)

    def luna_body_init_by_input_params(self, dh_params: List[List[float]], flange_length: float,
                                       joint_limit_neg: List[float], joint_limit_pos: List[float]) -> int:
        """Initialize the Luna body kinematics environment using input parameters.

        @param dh_params: Luna body DH parameter table (6x4).
        @param flange_length: Luna body flange length.
        @param joint_limit_neg: Lower joint limits (6 elements).
        @param joint_limit_pos: Upper joint limits (6 elements).
        @return: 0 on success, negative error code otherwise.
        @raise ValueError: If dh_params is not a 6x4 table, or a limit list does
                not have exactly 6 elements.
        """
        if len(dh_params) != 6 or any(len(row) != 4 for row in dh_params):
            raise ValueError("dh_params must be a 6x4 table")
        if len(joint_limit_neg) != 6 or len(joint_limit_pos) != 6:
            raise ValueError("joint_limit_neg and joint_limit_pos must have 6 elements each")
        self._ensure_kin_handle()
        dh_arr = ((c_double * 4) * 6)()
        for i in range(6):
            for j in range(4):
                dh_arr[i][j] = dh_params[i][j]
        neg_arr = (c_double * 6)(*joint_limit_neg)
        pos_arr = (c_double * 6)(*joint_limit_pos)
        return self.dll.FX_L1_Kinematics_LunaBodyInit_ByInputParams(
            self._kin_handle, dh_arr, flange_length, neg_arr, pos_arr
        )

    def luna_body_forward_kinematics(self, body_joints: List[float]) -> Union[
        Tuple[List[List[float]], List[List[float]]], int]:
        """Compute the left and right shoulder poses using Luna body forward kinematics.

        Given the six Luna body joint values, returns the 4x4 homogeneous
        transformation matrices for the arm0 and arm1 shoulders.

        @param body_joints: Luna body joint values (6 elements).
        @return: On success, a tuple of two 4x4 matrices (arm0_shoulder, arm1_shoulder),
                 each as a list of 4 rows of 4 floats. Negative error code otherwise.
        @raise ValueError: If body_joints does not have exactly 6 elements.
        """
        if len(body_joints) != 6:
            raise ValueError("body_joints must have 6 elements")
        self._ensure_kin_handle()
        j_arr = (c_double * 6)(*body_joints)
        arm0_mat = ((c_double * 4) * 4)()
        arm1_mat = ((c_double * 4) * 4)()
        ret = self.dll.FX_L1_Kinematics_LunaBodyForwardKinematics(
            self._kin_handle, j_arr, arm0_mat, arm1_mat
        )
        if ret == 0:
            arm0 = [[arm0_mat[i][j] for j in range(4)] for i in range(4)]
            arm1 = [[arm1_mat[i][j] for j in range(4)] for i in range(4)]
            return (arm0, arm1)
        else:
            return ret

    def luna_body_inverse_kinematics(self, arm0_shoulder_matrix: List[List[float]],
                                     arm1_shoulder_matrix: List[List[float]],
                                     ref_body_joints: List[float]) -> Union[List[float], int]:
        """Compute Luna body joint values from the left and right shoulder poses.

        @param arm0_shoulder_matrix: Arm 0 shoulder pose as a 4x4 homogeneous matrix.
        @param arm1_shoulder_matrix: Arm 1 shoulder pose as a 4x4 homogeneous matrix.
        @param ref_body_joints: Reference Luna body joint values used to select an
                inverse kinematics solution (6 elements).
        @return: Computed Luna body joint values as a list of 6 floats.
                 Negative error code otherwise.
        @raise ValueError: If a matrix is not 4x4 or ref_body_joints does not have
                exactly 6 elements.
        """
        if len(arm0_shoulder_matrix) != 4 or any(len(r) != 4 for r in arm0_shoulder_matrix):
            raise ValueError("arm0_shoulder_matrix must be a 4x4 matrix")
        if len(arm1_shoulder_matrix) != 4 or any(len(r) != 4 for r in arm1_shoulder_matrix):
            raise ValueError("arm1_shoulder_matrix must be a 4x4 matrix")
        if len(ref_body_joints) != 6:
            raise ValueError("ref_body_joints must have 6 elements")
        self._ensure_kin_handle()
        arm0_arr = ((c_double * 4) * 4)()
        arm1_arr = ((c_double * 4) * 4)()
        for i in range(4):
            for j in range(4):
                arm0_arr[i][j] = arm0_shoulder_matrix[i][j]
                arm1_arr[i][j] = arm1_shoulder_matrix[i][j]
        ref_arr = (c_double * 6)(*ref_body_joints)
        result_arr = (c_double * 6)()
        ret = self.dll.FX_L1_Kinematics_LunaBodyInverseKinematics(
            self._kin_handle, arm0_arr, arm1_arr, ref_arr, result_arr
        )
        if ret == 0:
            return [result_arr[i] for i in range(6)]
        else:
            return ret
    ...
    # ==================== Interference (collision detection) ====================
    def _ensure_interf_handle(self):
        """Create interference handle if not already created."""
        if self._interf_handle is None:
            self._interf_handle = self.dll.FX_Interf_Create()
            if not self._interf_handle:
                raise RuntimeError("Failed to create interference handle")

    def _destroy_interf_handle(self):
        """Destroy interference handle if it exists."""
        if self._interf_handle:
            self.dll.FX_Interf_Destroy(self._interf_handle)
            self._interf_handle = None

    def interf_init(self, cord_def: str, cal_link_def: str, input_def: str,
                    convex_def: str, ic_def: str) -> int:
        """Initialize the interference module from definition strings or file paths.

        @param cord_def: Coordinate system definition string or file path.
        @param cal_link_def: Link calibration parameter definition string or file path.
        @param input_def: External input variable mapping definition string or file path.
        @param convex_def: Convex collision geometry definition string or file path.
        @param ic_def: Interference check constraint rule definition string or file path.
        @return: 0 on success, negative error code otherwise.
        """
        self._ensure_interf_handle()

        def _enc(s):
            return s.encode('utf-8') if s else None

        return self.dll.FX_Interf_Init(self._interf_handle,
                                       _enc(cord_def), _enc(cal_link_def), _enc(input_def),
                                       _enc(convex_def), _enc(ic_def))

    def interf_update_cord(self, cord_num: int, cord_input: Sequence[float]) -> int:
        """Refresh real-time coordinate data of the specified coordinate group.

        @param cord_num: Target coordinate group index.
        @param cord_input: Raw coordinate double array (length follows loaded config).
        @return: 0 on success, negative error code otherwise.
        """
        self._ensure_interf_handle()
        arr = (c_double * len(cord_input))(*cord_input)
        return self.dll.FX_Interf_UpdateCord(self._interf_handle, c_long(cord_num), arr)

    def interf_update_convex(self) -> int:
        """Rebuild all convex hull collision geometry from the latest coordinates.

        @return: 0 on success, negative error code otherwise.
        """
        self._ensure_interf_handle()
        return self.dll.FX_Interf_UpdateConvex(self._interf_handle)

    def interf_calc_interf_distance(self) -> int:
        """Calculate the minimum separation distance for all collision pairs.

        @return: 0 on success, negative error code otherwise.
        """
        self._ensure_interf_handle()
        return self.dll.FX_Interf_CalInterfDistance(self._interf_handle)

    def interf_get_com(self) -> Tuple[int, List[float]]:
        """Get the mass-weighted average center of mass [X, Y, Z] of all rigid links.

        @return: Tuple (return_code, [x, y, z]).
        """
        self._ensure_interf_handle()
        arr = (c_double * 3)()
        ret = self.dll.FX_Interf_GetCoM(self._interf_handle, arr)
        return ret, [arr[i] for i in range(3)]

    def interf_get_cords_num(self) -> Tuple[int, int]:
        """Get the total count of loaded coordinate groups (input number).

        @return: Tuple (return_code, input_num).
        """
        self._ensure_interf_handle()
        n = c_long(0)
        ret = self.dll.FX_Interf_GetInputNum(self._interf_handle, byref(n))
        return ret, n.value

    def interf_get_mass(self) -> Tuple[int, List[float]]:
        """Get the mass scalar array for all defined rigid bodies.

        @return: Tuple (return_code, [mass, ...]). Length equals the coordinate group count.
        """
        ret, n = self.interf_get_cords_num()
        if ret != 0 or n <= 0:
            return ret, []
        arr = (c_double * n)()
        r = self.dll.FX_Interf_GetMass(self._interf_handle, arr)
        return r, [arr[i] for i in range(n)]
        if ret != 0 or n <= 0:
            return ret, []
        arr = (c_double * n)()
        r = self.dll.FX_Interf_GetMass(self._interf_handle, arr)
    ...
    def interf_get_interf_num(self) -> Tuple[int, int]:
        """Get the total count of configured collision pairs.

        @return: Tuple (return_code, interf_num).
        """
        self._ensure_interf_handle()
        n = c_long(0)
        ret = self.dll.FX_Interf_GetInterfNum(self._interf_handle, byref(n))
        return ret, n.value

    def interf_get_min_spans(self) -> Tuple[int, List[float]]:
        """Get the separation distance array for all collision pairs.

        The native FX_Interf_GetMinSpan writes one value per configured
        collision pair, so the buffer must be sized by the pair count.

        @return: Tuple (return_code, [span, ...]). Length equals the collision pair count.
        """
        self._ensure_interf_handle()
        ret, n = self.interf_get_interf_num()
        if ret != 0:
            return ret, []
        n = max(n, 1)
        arr = (c_double * n)()
        r = self.dll.FX_Interf_GetMinSpan(self._interf_handle, arr)
        return r, [arr[i] for i in range(n)]

    def interf_get_min_span(self) -> Tuple[int, float]:
        """Get the global minimal separation distance across all collision pairs.

        @return: Tuple (return_code, min_span).
        """
        ret, spans = self.interf_get_min_spans()
        if ret != 0 or not spans:
            return ret, 0.0
        return ret, min(spans)

    def interf_get_interf_span(self, serial: int) -> Tuple[int, float]:
        """Query the separation distance of a specific collision pair by serial index.

        @param serial: Unique serial index of the target collision pair.
        @return: Tuple (return_code, span).
        """
        self._ensure_interf_handle()
        v = c_double(0)
        ret = self.dll.FX_Interf_GetInterfSpan(self._interf_handle, c_long(serial), byref(v))
        return ret, v.value

    # ==================== Tool load identification ====================
    def start_sampling(self, arm: int, loadcode: int, traj_file_path: str):
        """Start the asynchronous tool load sampling task.

        Only one sampling task may run at a time. The robot must already be
        linked; the task samples joint data along the given trajectory. After the
        task finishes, call run_load_identification() to compute the load parameters.
        ...
        @return: A non-zero task handle (int) on success, or None on failure.
        @raise RuntimeError: If the robot is not connected.
        """
        if not self._connected:
            raise RuntimeError("Robot not connected")
        path_arg = traj_file_path.encode('utf-8') if traj_file_path else None
        handle = self.dll.FX_ToolDyn_Start_Sampling(arm, loadcode, path_arg)
        return handle if handle else None

    def get_sampling_status(self, handle) -> Union[Tuple[int, int, int], int]:
        """Query the running sampling task's status, progress and error code.

        @param handle: Task handle returned by start_sampling.
        @return: On success, a tuple (status, progress, error_code) where status is a
                 ToolDynTaskStatus value, progress is 0-100, and error_code is an
                 FXFuncReturn value. Non-zero return code on failure.
        """
        status = c_int32(0)
        progress = c_int32(0)
        error_code = c_int32(0)
        ret = self.dll.FX_ToolDyn_Get_Sampling_Status(handle, byref(status), byref(progress), byref(error_code))
        if ret == 0:
            return (status.value, progress.value, error_code.value)
        return ret

    def stop_sampling(self, handle) -> int:
        """Request the sampling task to stop.

        @param handle: Task handle returned by start_sampling.
        @return: 0 if stopped successfully, -1 on failure.
        """
        return self.dll.FX_ToolDyn_Stop_Sampling(handle)

    def destroy_sampling(self, handle) -> int:
        """Destroy the task handle and release resources. Call after the task ends.

        @param handle: Task handle returned by start_sampling.
        @return: 0 on success, -1 on failure (handle is NULL or task still running).
        """
        return self.dll.FX_ToolDyn_Destroy_Sampling(handle)

    def run_load_identification(self, arm: int, traj_file_path: str) -> Tuple[int, int, LoadDynamicPara]:
        """Run the load identification on previously sampled data.

        Synchronous computation: reads the sampled CSV files (produced by a completed
        start_sampling run) and computes the load parameters. It does not move the robot.

        @param arm: Arm number: 0 = left arm, 1 = right arm.
        @param traj_file_path: Trajectory file path (.fmv); also used to locate the
               sampled-data directory.
        @return: Tuple (ret, error_code, dyn_para). ret == 0 and error_code == 0
                 (FUNC_RET_SUCCESS) indicate success; dyn_para is a LoadDynamicPara
                 filled with the result.
        """
        error_code = c_int32(0)
        out_para = LoadDynamicPara()
        path_arg = traj_file_path.encode('utf-8') if traj_file_path else None
        ret = self.dll.FX_ToolDyn_Run_Load_Identification(arm, byref(error_code), byref(out_para), path_arg)
        return ret, error_code.value, out_para

    # ---------- Cleanup ----------
    def cleanup(self):
        """Clean up all resources including kinematics and interference handles."""
        self._destroy_kin_handle()
        self._destroy_interf_handle()
    ...
    def _get_operate_error_msg(error_code: int) -> str:
        errors = {
            ...
            -24: "Too many sample data item registed",
            -25: "Invalid sample data item",
            -26: "Invalid sample data length",
            -27: "Link lost while calling function",
            -28: "PDO data not init complete",
            -29: "Mass position exceeds limit",
            -30: "Robot position is interfered",
            ...
            -1031: "Load identification calculation error",
            -1032: "Failed to open sample data file",
            -1033: "Failed to open configuration file",
            -1034: "Data sampling error during load identification",
            -1035: "Invalid load identification type",
            -1036: "Trajectory file does not exist or directory is incorrect",
            -1037: "Sampling save directory does not exist",
            -1038: "Sampling configuration failed",
            -1039: "Trajectory operation failed",
...
class HandDataManager:
    """On-demand background thread manager for continuously fetching hand data.

    Heavier than RT/SG fetching (two 512-byte reads per cycle at 1 kHz), so it is
    kept separate from RobotDataManager and only runs after an explicit start().
    """

    def __init__(self, robot):
        """Initialize the manager. Fetching does not start until start() is called.

        @param robot: GentoRobot instance.
        """
        self.robot = robot
        self._latest_hand_in = None
        self._latest_hand_out = None
        self._running = False
        self._thread = None

    def start(self):
        """Start the background fetch thread. Has no effect if already running."""
        if self._running:
            return
        self._running = True
        self._thread = threading.Thread(target=self._fetch_hand, daemon=True)
        self._thread.start()
    ...
    @property
    def is_running(self):
        """Whether the background fetch thread is running."""
        return self._running

    def _fetch_hand(self):
        """Background thread to fetch hand PDO data (1000 Hz)."""
        while self._running:
            try:
                self._latest_hand_in = self.robot.get_hand_in_dict()
                self._latest_hand_out = self.robot.get_hand_out_dict()
            except:
                self._latest_hand_in = None
                self._latest_hand_out = None
            time.sleep(0.001)
    ...
    @property
    def latest_hand_in(self):
        """Get the latest hand input (rxpdo) data dictionary (thread-safe)."""
        return self._latest_hand_in

    @property
    def latest_hand_out(self):
        """Get the latest hand output (txpdo) data dictionary (thread-safe)."""
        return self._latest_hand_out
...
if __name__ == "__main__":
    ...
    print(f"robot type:{robot.get_robot_type()}")
    ...
    hand_in  = robot.get_hand_in_dict()    
    hand_out = robot.get_hand_out_dict()   
    print("hands input frame_serial:", hand_in["frame_serial"])
    print("hand0 output data:",hand_out["data"][0])      
    print("hand1 output data:",hand_out["data"][1])   
    ...
    print("TipDI:", sg_dict["arms"][0]['get']["tip_di"])
    print("TrajState:", sg_dict["arms"][0]['get']["traj_state"])
    print("joint k:", sg_dict["arms"][0]['set']['joint_k'])
    print("joint d:", sg_dict["arms"][0]['set']['joint_d'])
    print("cart k:", sg_dict["arms"][0]['set']['cart_k'])
    print("cart d:", sg_dict["arms"][0]['set']['cart_d'])
    print("pd k:", sg_dict["arms"][0]['set']['pd_k'])
    print("pd d:", sg_dict["arms"][0]['set']['pd_d'])

    print("body pd")
    print("pd k:", sg_dict["body"]['set']['pdk'])
    print("pd d:", sg_dict["body"]['set']['pdd'])
