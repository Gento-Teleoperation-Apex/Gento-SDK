...
set SDK_CPP=./FXUtility/FXMath/*.cpp ./FXUtility/FXCfg/*.cpp ./Interf/*.cpp ./ToolDynaIdent/*.cpp ./Kinematics/*.cpp ./Kinematics/ArmKinematics/*.cpp ./Kinematics/KineCommon/*.cpp ./Kinematics/MotionPlanner/*.cpp ./Kinematics/SkyeBodyKinematics/*.cpp ./Kinematics/LunaBodyKinematics/*.cpp ./FileClient/*.cpp ./L0Control/*.cpp ./L1Robot/*.cpp

REM SDK include dirs (relative to C_SDK, same set as ..\win_auto_compile.bat).
set INC_DIRS=-I./Common -I./FXUtility -I./FXUtility/FXMath -I./FXUtility/FXCfg -I./Interf -I./ToolDynaIdent -I./Kinematics -I./Kinematics/ArmKinematics -I./Kinematics/KineCommon -I./Kinematics/MotionPlanner -I./Kinematics/SkyeBodyKinematics -I./Kinematics/LunaBodyKinematics -I./FileClient -I./L0Control -I./L1Robot
...
echo --------------------------------------------
pushd "%SDK_DIR%"
g++ -w "%SCRIPT_DIR%!NAME!.cpp" %SDK_CPP% %INC_DIRS% -o "%SCRIPT_DIR%!NAME!.exe" -DCMPL_WIN -DL1_SDK_EXPORTS -static -static-libgcc -static-libstdc++ -lws2_32 -lwinmm
set RC=!ERRORLEVEL!
popd
if !RC! NEQ 0 (
