...
extern "C"
{
     ...
     * @return Defined in FXFuncReturn.
     */
    INTERF_SDK_API int FX_Interf_CalInterfDistance(FX_InterfHandle handle);
     ...
     * @return Defined in FXFuncReturn.
     */
    INTERF_SDK_API int FX_Interf_GetInputNum(FX_InterfHandle handle, long *input_num);
    ...
    /**
     * @brief Get total count of configured collision pairs in interference context
     *
     * Retrieve the total number of valid collision pairs registered inside current interference handle.
     * This value can be used as upper bound for serial index iteration when calling FX_Interf_GetInterfSpan().
     *
     * @param[in] handle Interference context handle, obtained from FX_Interf_Create()
     * @param[out] interf_num Pointer to output total collision pair count
     *
     * @return Defined in FXFuncReturn.
     */
    INTERF_SDK_API int FX_Interf_GetInterfNum(FX_InterfHandle handle, long *interf_num);
