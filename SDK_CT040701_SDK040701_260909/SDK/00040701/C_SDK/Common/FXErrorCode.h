...
typedef enum
{
    ...
    ERR_InvalidRobotIMU = 115,     ///< No robot IMU device
    ERR_InvalidAgvIMU = 116,       ///< No AGV IMU device
} FXErrorCode;
...
typedef enum
{
    ...
    FUNC_RET_LINK_LOST = -27,               ///< Link lost while calling function
    FUNC_RET_PDO_NO_COMPLETE = -28,         ///< PDO data not init complete
    FUNC_RET_OVER_MASS_LIMIT = -29,         ///< Mass position exceeds limit
    FUNC_RET_ROBOT_INTERFERED = -30,        ///<Robot position is interfered
    ...
    FUNC_RET_LOAD_IDENT_CALC_ERROR = -1031,             ///< Load identification calculation error
    FUNC_RET_LOAD_IDENT_OPEN_SAMPLE_FILE_FAILED = -1032,///< Failed to open sample data file
    FUNC_RET_LOAD_IDENT_OPEN_CONFIG_FILE_FAILED = -1033,///< Failed to open configuration file
    FUNC_RET_LOAD_IDENT_DATA_SAMPLE_ERROR = -1034,      ///< Data sampling error during load identification
    FUNC_RET_LOAD_IDENT_TYPE_ERROR = -1035,             ///< Invalid load identification type
    FUNC_RET_LOAD_TRAJECTORY_FILE_OR_DIR_INVALID = -1036,    ///< Trajectory file does not exist or directory is incorrect
    FUNC_RET_LOAD_SAMPLE_SAVE_DIR_NOT_EXIST = -1037,         ///< Sampling save directory does not exist
    FUNC_RET_LOAD_SAMPLE_CONFIG_FAILED = -1038,              ///< Sampling configuration failed
    FUNC_RET_LOAD_TRAJECTORY_OPERATION_FAILED = -1039,       ///< Trajectory operation failed
