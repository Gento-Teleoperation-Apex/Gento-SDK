...
static const OffsetTableItem g_RT_OffsetTable[] =
{
    ...
    {"ROBOT_RT.m_DEVICE.m_DEVICE_FBK_Robot_IMU",            FX_float,             9},
    {"ROBOT_RT.m_DEVICE.m_DEVICE_FBK_Agv_IMU",              FX_float,             9},
...
static const OffsetTableItem g_SG_OffsetTable[] =
{
    ...
    {"ROBOT_SG.m_ARMS[0].m_ARM_SET.m_ARM_Ctrl_PDK",         FX_float,             7},
    {"ROBOT_SG.m_ARMS[0].m_ARM_SET.m_ARM_Ctrl_PDD",         FX_float,             7},
    {"ROBOT_SG.m_ARMS[0].m_ARM_SET.m_ARM_Ctrl_ToolKine",    FX_float,             6},
    {"ROBOT_SG.m_ARMS[0].m_ARM_SET.m_ARM_Ctrl_ToolDyna",    FX_float,            10},
    {"ROBOT_SG.m_ARMS[0].m_ARM_SET.m_ARM_SET_SetTag",       FX_char,             20},
    {"ROBOT_SG.m_ARMS[0].m_ARM_SET.m_ARM_SET_UpdateTag",    FX_char,             20},
    ...
    {"ROBOT_SG.m_ARMS[1].m_ARM_SET.m_ARM_Ctrl_PDK",         FX_float,             7},
    {"ROBOT_SG.m_ARMS[1].m_ARM_SET.m_ARM_Ctrl_PDD",         FX_float,             7},
    {"ROBOT_SG.m_ARMS[1].m_ARM_SET.m_ARM_Ctrl_ToolKine",    FX_float,             6},
    {"ROBOT_SG.m_ARMS[1].m_ARM_SET.m_ARM_Ctrl_ToolDyna",    FX_float,            10},
    {"ROBOT_SG.m_ARMS[1].m_ARM_SET.m_ARM_SET_SetTag",       FX_char,             20},
    {"ROBOT_SG.m_ARMS[1].m_ARM_SET.m_ARM_SET_UpdateTag",    FX_char,             20},
