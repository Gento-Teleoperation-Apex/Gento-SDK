...
extern "C"
{
   ...
   * @return 0 on success, -1 on failure.
   */
  CONTROL_SDK_API int FX_L0_System_RestoreImage(void);
   ...
   * @return 0 on success, -1 on failure.
   */
  CONTROL_SDK_API int FX_L0_System_SetUserFbkType(int chn_id, int fbk_type);
   ...
   * @return 0 on success, -1 on failure.
   */
  CONTROL_SDK_API int FX_L0_System_SetSN(char serial[30]);
   ...
   * @return 0 on success, -1 on failure.
   */
  CONTROL_SDK_API int FX_L0_System_GetSN(char serial[30]);
   ...
   * @return 0 on success, -1 on failure.
   */
  CONTROL_SDK_API int FX_L0_System_SdoWriteInt8(int master_id, int slave_pos, unsigned int object_index, unsigned int object_subindex, int8_t object_data);
   ...
   * @return 0 on success, -1 on failure.
   */
  CONTROL_SDK_API int FX_L0_System_SdoReadInt8(int master_id, int slave_pos, unsigned int object_index, unsigned int object_subindex, int8_t* object_data);
   ...
   * @return 0 on success, -1 on failure.
   */
  CONTROL_SDK_API int FX_L0_System_SdoWriteUInt8(int master_id, int slave_pos, unsigned int object_index, unsigned int object_subindex, uint8_t object_data);
   ...
   * @return 0 on success, -1 on failure.
   */
  CONTROL_SDK_API int FX_L0_System_SdoReadUInt8(int master_id, int slave_pos, unsigned int object_index, unsigned int object_subindex, uint8_t* object_data);
   ...
   * @return 0 on success, -1 on failure.
   */
  CONTROL_SDK_API int FX_L0_System_SdoWriteInt16(int master_id, int slave_pos, unsigned int object_index, unsigned int object_subindex, int16_t object_data);
   ...
   * @return 0 on success, -1 on failure.
   */
  CONTROL_SDK_API int FX_L0_System_SdoReadInt16(int master_id, int slave_pos, unsigned int object_index, unsigned int object_subindex, int16_t* object_data);
   ...
   * @return 0 on success, -1 on failure.
   */
  CONTROL_SDK_API int FX_L0_System_SdoWriteUInt16(int master_id, int slave_pos, unsigned int object_index, unsigned int object_subindex, uint16_t object_data);
   ...
   * @return 0 on success, -1 on failure.
   */
  CONTROL_SDK_API int FX_L0_System_SdoReadUInt16(int master_id, int slave_pos, unsigned int object_index, unsigned int object_subindex, uint16_t* object_data);
   ...
   * @return 0 on success, -1 on failure.
   */
  CONTROL_SDK_API int FX_L0_System_SdoWriteInt32(int master_id, int slave_pos, unsigned int object_index, unsigned int object_subindex, int32_t object_data);
   ...
   * @return 0 on success, -1 on failure.
   */
  CONTROL_SDK_API int FX_L0_System_SdoReadInt32(int master_id, int slave_pos, unsigned int object_index, unsigned int object_subindex, int32_t* object_data);
   ...
   * @return 0 on success, -1 on failure.
   */
  CONTROL_SDK_API int FX_L0_System_SdoWriteUInt32(int master_id, int slave_pos, unsigned int object_index, unsigned int object_subindex, uint32_t object_data);
   ...
   * @return 0 on success, -1 on failure.
   */
  CONTROL_SDK_API int FX_L0_System_SdoReadUInt32(int master_id, int slave_pos, unsigned int object_index, unsigned int object_subindex, uint32_t* object_data);
  ...
  /**
   * @brief Get Arm0's hand type.
   *
   * @param hand_type_ptr Hand type pointer.
   * @return 0 on success, -1 on failure.
   */
  CONTROL_SDK_API int FX_L0_Arm0_Hand_GetType(int* hand_type_ptr);
  
  /**
   * @brief Retrieve data from Arm0 hand.
   *
   * @param data_serial_ptr Output pointer for data serial.
   * @param data_ptr Output buffer for received data.
   * @return 0 on success, -1 on failure.
   */
  CONTROL_SDK_API int FX_L0_Arm0_Hand_GetData(int* data_serial_ptr, unsigned char data_ptr[512]);
  
  /**
   * @brief Send data to Arm0 hand.
   *
   * @param data_ptr Pointer to data buffer.
   * @return 0 on success, -1 on failure.
   */
  CONTROL_SDK_API int FX_L0_Arm0_Hand_SetData(unsigned char data_ptr[512]);

  /**
   * @brief Get Arm1's hand type.
   *
   * @param hand_type_ptr Hand type pointer.
   * @return 0 on success, -1 on failure.
   */
  CONTROL_SDK_API int FX_L0_Arm1_Hand_GetType(int* hand_type_ptr);
  
  /**
   * @brief Retrieve data from Arm1 hand.
   *
   * @param data_serial_ptr Output pointer for data serial.
   * @param data_ptr Output buffer for received data.
   * @return 0 on success, -1 on failure.
   */
  CONTROL_SDK_API int FX_L0_Arm1_Hand_GetData(int* data_serial_ptr, unsigned char data_ptr[512]);
  
  /**
   * @brief Send data to Arm1 hand.
   *
   * @param data_ptr Pointer to data buffer.
   * @return 0 on success, -1 on failure.
   */
  CONTROL_SDK_API int FX_L0_Arm1_Hand_SetData(unsigned char data_ptr[512]);
  ...
  /**
   * @brief Set proportional gain for Arm0 PD control.
   *
   * @param thread_id Thread ID for this function call, range 0~7.
   * @param p Proportional gain array.
   * @return 0 on success, -1 on failure.
   */
  CONTROL_SDK_API int FX_L0_Arm0_Runtime_SetPDP(unsigned int thread_id, double p[7]);

  /**
   * @brief Set derivative gain for Arm0 PD control.
   *
   * @param thread_id Thread ID for this function call, range 0~7.
   * @param p Derivative gain array.
   * @return 0 on success, -1 on failure.
   */
  CONTROL_SDK_API int FX_L0_Arm0_Runtime_SetPDD(unsigned int thread_id, double d[7]);
  ...
  /**
   * @brief Set the reference orientation for the Cartesian impedance or
   *        hand-guiding control of Arm0 in the FX-L0 runtime.
   *
   * This function updates the desired orientation (equilibrium orientation of
   * the impedance model) used by the real-time control thread specified by
   * @p thread_id.
   *
   * The interpretation of @p ref_ori depends on @p ref_ori_type. For example,
   * it may represent Euler angles (roll, pitch, yaw) or a quaternion, depending
   * on the runtime configuration.
   *
   * @param[in] thread_id     Real-time control thread identifier.
   * @param[in] ref_ori_type  Representation type of the reference orientation.
   * @param[in] ref_ori       Array of orientation parameters.
   *                          - For Euler angles: [roll, pitch, yaw] (degree).
   *                          The required length depends on @p ref_ori_type.
   *
   * @return 0 on success, -1 on failure.
   */
  CONTROL_SDK_API int FX_L0_Arm0_Runtime_SetRefOri(unsigned int thread_id, int ref_ori_type, double ref_ori[3]);
  /**
   * @brief Update arm0's 'joint control commands in MIT Mode during runtime.
   *
   ...
   * @return 0 on success, -1 on failure.
   */
  CONTROL_SDK_API int FX_L0_Arm0_Runtime_SetJointMITCmd(unsigned int thread_id, double pos_cmd[7], double vel_cmd[7], double tor_cmd[7], double k[7], double d[7]);
  ...
  /**
   * @brief Set proportional gain of for Arm1 PD control.
   *
   * @param thread_id Thread ID for this function call, range 0~7.
   * @param p Proportional gain array.
   * @return 0 on success, -1 on failure.
   */
  CONTROL_SDK_API int FX_L0_Arm1_Runtime_SetPDP(unsigned int thread_id, double p[7]);

  /**
   * @brief Set derivative gain of for Arm1 PD control.
   *
   * @param thread_id Thread ID for this function call, range 0~7.
   * @param p Derivative gain array.
   * @return 0 on success, -1 on failure.
   */
  CONTROL_SDK_API int FX_L0_Arm1_Runtime_SetPDD(unsigned int thread_id, double d[7]);
  ...
  /**
   * @brief Set the reference orientation for the Cartesian impedance or
   *        hand-guiding control of Arm1 in the FX-L0 runtime.
   *
   * This function updates the desired orientation (equilibrium orientation of
   * the impedance model) used by the real-time control thread specified by
   * @p thread_id.
   ...
   * @return 0 on success, -1 on failure.
   */
  CONTROL_SDK_API int FX_L0_Arm1_Runtime_SetRefOri(unsigned int thread_id, int ref_ori_type, double ref_ori[3]);
  /**
    * @brief Update arm1's 'joint control commands in MIT Mode during runtime.
    *
    * Sets the real-time control references for all 7 joints when the controller is
    * operating in User MIT Mode. This function overwrites the previous control
    * setpoints and gains without requiring a state transition. The controller applies
    ...
    * @return 0 on success, -1 on failure.
    */
  CONTROL_SDK_API int FX_L0_Arm1_Runtime_SetJointMITCmd(unsigned int thread_id, double pos_cmd[7], double vel_cmd[7], double tor_cmd[7], double k[7], double d[7]);
