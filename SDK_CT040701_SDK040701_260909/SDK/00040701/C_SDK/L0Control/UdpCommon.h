...
typedef enum
{
    ...
    UDP_ARM0_SG_PDK = 11,           //settag[10]
    UDP_ARM0_SG_PDD = 12,           //settag[11] 
	UDP_ARM0_SG_ToolK = 13,         //settag[12]
	UDP_ARM0_SG_ToolD = 14,         //settag[13]
	UDP_ARM0_SG_ImpType = 15,       //settag[14] 	
    UDP_ARM0_RT_DragType = 16,      //settag[15]
    UDP_ARM0_RT_RefOri = 17,        //settag[16]
    UDP_ARM0_RT_CmdPDSerial = 18,   //settag[17]
    UDP_ARM0_RT_CmdTag = 19,
    ...
    UDP_ARM1_SG_PDK = 41,           //settag[10]
    UDP_ARM1_SG_PDD = 42,           //settag[11] 
    UDP_ARM1_SG_ToolK = 43,         //settag[12]
    UDP_ARM1_SG_ToolD = 44,         //settag[13]
    UDP_ARM1_SG_ImpType = 45,       //settag[14]    
    UDP_ARM1_RT_DragType = 46,      //settag[15]
    UDP_ARM1_RT_RefOri = 47,        //settag[16]
    UDP_ARM1_RT_CmdPDSerial = 48,   //settag[17]
    UDP_ARM1_RT_CmdTag = 49,
    ...
    UDP_SYSTEM_RT_UserFbkType0 = 150,
    UDP_SYSTEM_RT_UserFbkType1 = 151,
    UDP_SYSTEM_RT_UserFbkType2 = 152,
    UDP_SYSTEM_RT_UserFbkType3 = 153,
    ...
    UDP_ARM0_SP_CmdMIT = 230,   // special cmd
    UDP_ARM1_SP_CmdMIT = 231,   // special cmd
...
typedef enum
{
	...
	OPINS_SYSTEM_RESTORE_IMAGE = 20,         // Input: null; Output: null
	OPINS_SYSTEM_SET_SN = 21,                // Input: m_OpValueS; Output: null
	OPINS_SYSTEM_GET_SN = 22,                // Input: null; Output: m_OpValueS	
    OPINS_SYSTEM_SET_SDO_INT8 = 23, // Input: m_OpValueI, index(16b):subindex(8b):master_id(4b):slave_pos(4b);  m_OpValueS, value data; Output: null
    OPINS_SYSTEM_GET_SDO_INT8 = 24, // Input: m_OpValueI, index(16b):subindex(8b):master_id(4b):slave_pos(4b);  Output: m_OpValueS
    OPINS_SYSTEM_SET_SDO_UINT8 = 25, // Input: m_OpValueI, index(16b):subindex(8b):master_id(4b):slave_pos(4b);  m_OpValueS, value data; Output: null
    OPINS_SYSTEM_GET_SDO_UINT8 = 26, // Input: m_OpValueI, index(16b):subindex(8b):master_id(4b):slave_pos(4b);  Output: m_OpValueS
    OPINS_SYSTEM_SET_SDO_INT16 = 27, // Input: m_OpValueI, index(16b):subindex(8b):master_id(4b):slave_pos(4b);  m_OpValueS, value data; Output: null
    OPINS_SYSTEM_GET_SDO_INT16 = 28, // Input: m_OpValueI, index(16b):subindex(8b):master_id(4b):slave_pos(4b);  Output: m_OpValueS
    OPINS_SYSTEM_SET_SDO_UINT16 = 29, // Input: m_OpValueI, index(16b):subindex(8b):master_id(4b):slave_pos(4b);  m_OpValueS, value data; Output: null
    OPINS_SYSTEM_GET_SDO_UINT16 = 30, // Input: m_OpValueI, index(16b):subindex(8b):master_id(4b):slave_pos(4b);  Output: m_OpValueS
    OPINS_SYSTEM_SET_SDO_INT32 = 31, // Input: m_OpValueI, index(16b):subindex(8b):master_id(4b):slave_pos(4b);  m_OpValueS, value data; Output: null
    OPINS_SYSTEM_GET_SDO_INT32 = 32, // Input: m_OpValueI, index(16b):subindex(8b):master_id(4b):slave_pos(4b);  Output: m_OpValueS
    OPINS_SYSTEM_SET_SDO_UINT32 = 33, // Input: m_OpValueI, index(16b):subindex(8b):master_id(4b):slave_pos(4b);  m_OpValueS, value data; Output: null
    OPINS_SYSTEM_GET_SDO_UINT32 = 34, // Input: m_OpValueI, index(16b):subindex(8b):master_id(4b):slave_pos(4b);  Output: m_OpValueS
	...
	OPINS_ARM0_HAND_GET_TYPE = 156,              // Input: null; Output: m_OpValueI, HandType
	...
	OPINS_ARM1_HAND_GET_TYPE = 256,              // Input: null; Output: m_OpValueI, HandType
...
/**
 * @brief Hand rxpdo data structure.
 */
typedef struct
{
    FX_UINT8 data[512];
...
/**
 * @brief Hand txpdo data structure (updated by 1000 Hz).
 */
typedef struct
{
    FX_INT32 m_FrameSerial; ///* 输出帧序号   0 -  1000000 取模*////
    FX_UINT8 data[512];
} HAND_OUT;
