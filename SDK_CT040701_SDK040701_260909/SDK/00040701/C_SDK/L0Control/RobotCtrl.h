...
public:
    ...
    static FX_BOOL System_RestoreImage();
    static FX_BOOL System_SetUserFbkType(FX_INT32 chn_id, FX_INT16 fbk_type);
    static FX_BOOL System_SetSN(char serial_number[30]);
    static FX_BOOL System_GetSN(char serial_number[30]);
    static FX_BOOL System_SdoWriteInt8(FX_INT32 master_id, FX_INT32 slave_pos, FX_UINT16 object_index, FX_UINT8 object_subindex, FX_INT8 object_data);
    static FX_BOOL System_SdoReadInt8(FX_INT32 master_id, FX_INT32 slave_pos, FX_UINT16 object_index, FX_UINT8 object_subindex, FX_INT8* object_data);
    static FX_BOOL System_SdoWriteUInt8(FX_INT32 master_id, FX_INT32 slave_pos, FX_UINT16 object_index, FX_UINT8 object_subindex, FX_UINT8 object_data);
    static FX_BOOL System_SdoReadUInt8(FX_INT32 master_id, FX_INT32 slave_pos, FX_UINT16 object_index, FX_UINT8 object_subindex, FX_UINT8* object_data);
    static FX_BOOL System_SdoWriteInt16(FX_INT32 master_id, FX_INT32 slave_pos, FX_UINT16 object_index, FX_UINT8 object_subindex, FX_INT16 object_data);
    static FX_BOOL System_SdoReadInt16(FX_INT32 master_id, FX_INT32 slave_pos, FX_UINT16 object_index, FX_UINT8 object_subindex, FX_INT16* object_data);
    static FX_BOOL System_SdoWriteUInt16(FX_INT32 master_id, FX_INT32 slave_pos, FX_UINT16 object_index, FX_UINT8 object_subindex, FX_UINT16 object_data);
    static FX_BOOL System_SdoReadUInt16(FX_INT32 master_id, FX_INT32 slave_pos, FX_UINT16 object_index, FX_UINT8 object_subindex, FX_UINT16* object_data);
    static FX_BOOL System_SdoWriteInt32(FX_INT32 master_id, FX_INT32 slave_pos, FX_UINT16 object_index, FX_UINT8 object_subindex, FX_INT32 object_data);
    static FX_BOOL System_SdoReadInt32(FX_INT32 master_id, FX_INT32 slave_pos, FX_UINT16 object_index, FX_UINT8 object_subindex, FX_INT32* object_data);
    static FX_BOOL System_SdoWriteUInt32(FX_INT32 master_id, FX_INT32 slave_pos, FX_UINT16 object_index, FX_UINT8 object_subindex, FX_UINT32 object_data);
    static FX_BOOL System_SdoReadUInt32(FX_INT32 master_id, FX_INT32 slave_pos, FX_UINT16 object_index, FX_UINT8 object_subindex, FX_UINT32* object_data);
    ...
    static FX_BOOL Arm0_Hand_GetType(FX_INT32* hand_type);
    static FX_BOOL Arm0_Hand_GetData(FX_INT32* data_serial_ptr, FX_UCHAR data_ptr[512]);
    static FX_BOOL Arm0_Hand_SetData(FX_UCHAR data_ptr[512]);
    static FX_BOOL Arm1_Hand_GetType(FX_INT32* hand_type);
    static FX_BOOL Arm1_Hand_GetData(FX_INT32* data_serial_ptr, FX_UCHAR data_ptr[512]);
    static FX_BOOL Arm1_Hand_SetData(FX_UCHAR data_ptr[512]);
    ...
    static FX_BOOL Arm0_Runtime_SetPDP(FX_UINT32 thread_id, FX_DOUBLE p[7]);
    static FX_BOOL Arm0_Runtime_SetPDD(FX_UINT32 thread_id, FX_DOUBLE d[7]);
    ...
    static FX_BOOL Arm0_Runtime_SetRefOri(FX_UINT32 thread_id, FX_INT16 ref_ori_type, FX_DOUBLE ref_ori[3]);
	static FX_BOOL Arm0_Runtime_SetCmdPDSerial(FX_UINT32 thread_id, FX_INT16 serial);
    static FX_BOOL Arm0_Runtime_SetJointMITCmd(FX_UINT32 thread_id, FX_DOUBLE pos_cmd[7], FX_DOUBLE vel_cmd[7], FX_DOUBLE tor_cmd[7], FX_DOUBLE k[7], FX_DOUBLE d[7]);
    ...
    static FX_BOOL Arm1_Runtime_SetPDP(FX_UINT32 thread_id, FX_DOUBLE p[7]);
    static FX_BOOL Arm1_Runtime_SetPDD(FX_UINT32 thread_id, FX_DOUBLE d[7]);
    ...
    static FX_BOOL Arm1_Runtime_SetRefOri(FX_UINT32 thread_id, FX_INT16 ref_ori_type, FX_DOUBLE ref_ori[3]);
	static FX_BOOL Arm1_Runtime_SetCmdPDSerial(FX_UINT32 thread_id, FX_INT16 serial);
    static FX_BOOL Arm1_Runtime_SetJointMITCmd(FX_UINT32 thread_id, FX_DOUBLE pos_cmd[7], FX_DOUBLE vel_cmd[7], FX_DOUBLE tor_cmd[7], FX_DOUBLE k[7], FX_DOUBLE d[7]);
...
private:
    ...
    CMarvNetAgent m_Hand0_NA;
    CMarvNetAgent m_Hand1_NA;
	CACB m_ACB1;
	CACB m_ACB2;
    CACB m_ACB_Msg;
    ...
    static FX_INT32 PackSdoInsIndex(FX_INT32 master_id, FX_INT32 slave_pos, FX_UINT16 object_index, FX_UINT8 object_subindex);
};
#endif
