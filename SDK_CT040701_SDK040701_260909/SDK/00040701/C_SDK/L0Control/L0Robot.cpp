...
int FX_L0_System_RestoreImage(void)
{
    return ((RobotCtrl::System_RestoreImage() == FX_TRUE) ? 0 : -1);
}

int FX_L0_System_SetUserFbkType(int chn_id, int fbk_type)
{
    short fbk_type_short = fbk_type;
    return ((RobotCtrl::System_SetUserFbkType(chn_id, fbk_type_short) == FX_TRUE) ? 0 : -1);
}

int FX_L0_System_SetSN(char serial[30])
{
    return ((RobotCtrl::System_SetSN(serial) == FX_TRUE) ? 0 : -1);
}

int FX_L0_System_GetSN(char serial[30])
{
    return ((RobotCtrl::System_GetSN(serial) == FX_TRUE) ? 0 : -1);
}

int FX_L0_System_SdoWriteInt8(int master_id, int slave_pos, unsigned int object_index, unsigned int object_subindex, int8_t object_data)
{
    return ((RobotCtrl::System_SdoWriteInt8(master_id, slave_pos, object_index, object_subindex, object_data) == FX_TRUE) ? 0 : -1);
}

int FX_L0_System_SdoReadInt8(int master_id, int slave_pos, unsigned int object_index, unsigned int object_subindex, int8_t* object_data)
{
    return ((RobotCtrl::System_SdoReadInt8(master_id, slave_pos, object_index, object_subindex, object_data) == FX_TRUE) ? 0 : -1);
}

int FX_L0_System_SdoWriteUInt8(int master_id, int slave_pos, unsigned int object_index, unsigned int object_subindex, uint8_t object_data)
{
    return ((RobotCtrl::System_SdoWriteUInt8(master_id, slave_pos, object_index, object_subindex, object_data) == FX_TRUE) ? 0 : -1);
}

int FX_L0_System_SdoReadUInt8(int master_id, int slave_pos, unsigned int object_index, unsigned int object_subindex, uint8_t* object_data)
{
    return ((RobotCtrl::System_SdoReadUInt8(master_id, slave_pos, object_index, object_subindex, object_data) == FX_TRUE) ? 0 : -1);
}

int FX_L0_System_SdoWriteInt16(int master_id, int slave_pos, unsigned int object_index, unsigned int object_subindex, int16_t object_data)
{
    return ((RobotCtrl::System_SdoWriteInt16(master_id, slave_pos, object_index, object_subindex, object_data) == FX_TRUE) ? 0 : -1);
}

int FX_L0_System_SdoReadInt16(int master_id, int slave_pos, unsigned int object_index, unsigned int object_subindex, int16_t* object_data)
{
    return ((RobotCtrl::System_SdoReadInt16(master_id, slave_pos, object_index, object_subindex, object_data) == FX_TRUE) ? 0 : -1);
}

int FX_L0_System_SdoWriteUInt16(int master_id, int slave_pos, unsigned int object_index, unsigned int object_subindex, uint16_t object_data)
{
    return ((RobotCtrl::System_SdoWriteUInt16(master_id, slave_pos, object_index, object_subindex, object_data) == FX_TRUE) ? 0 : -1);
}

int FX_L0_System_SdoReadUInt16(int master_id, int slave_pos, unsigned int object_index, unsigned int object_subindex, uint16_t* object_data)
{
    return ((RobotCtrl::System_SdoReadUInt16(master_id, slave_pos, object_index, object_subindex, object_data) == FX_TRUE) ? 0 : -1);
}

int FX_L0_System_SdoWriteInt32(int master_id, int slave_pos, unsigned int object_index, unsigned int object_subindex, int32_t object_data)
{
    return ((RobotCtrl::System_SdoWriteInt32(master_id, slave_pos, object_index, object_subindex, object_data) == FX_TRUE) ? 0 : -1);
}

int FX_L0_System_SdoReadInt32(int master_id, int slave_pos, unsigned int object_index, unsigned int object_subindex, int32_t* object_data)
{
    return ((RobotCtrl::System_SdoReadInt32(master_id, slave_pos, object_index, object_subindex, object_data) == FX_TRUE) ? 0 : -1);
}

int FX_L0_System_SdoWriteUInt32(int master_id, int slave_pos, unsigned int object_index, unsigned int object_subindex, uint32_t object_data)
{
    return ((RobotCtrl::System_SdoWriteUInt32(master_id, slave_pos, object_index, object_subindex, object_data) == FX_TRUE) ? 0 : -1);
}

int FX_L0_System_SdoReadUInt32(int master_id, int slave_pos, unsigned int object_index, unsigned int object_subindex, uint32_t* object_data)
{
    return ((RobotCtrl::System_SdoReadUInt32(master_id, slave_pos, object_index, object_subindex, object_data) == FX_TRUE) ? 0 : -1);
}
...
int FX_L0_Arm0_Hand_GetType(int* hand_type_ptr)
{
    return ((RobotCtrl::Arm0_Hand_GetType(hand_type_ptr) == FX_TRUE) ? 0 : -1);
}

int FX_L0_Arm0_Hand_GetData(int* data_serial_ptr, unsigned char data_ptr[512])
{
    return ((RobotCtrl::Arm0_Hand_GetData(data_serial_ptr, data_ptr) == FX_TRUE) ? 0 : -1);
}

int FX_L0_Arm0_Hand_SetData(unsigned char data_ptr[512])
{
    return ((RobotCtrl::Arm0_Hand_SetData(data_ptr) == FX_TRUE) ? 0 : -1);
}

int FX_L0_Arm1_Hand_GetType(int* hand_type_ptr)
{
    return ((RobotCtrl::Arm1_Hand_GetType(hand_type_ptr) == FX_TRUE) ? 0 : -1);
}

int FX_L0_Arm1_Hand_GetData(int* data_serial_ptr, unsigned char data_ptr[512])
{
    return ((RobotCtrl::Arm1_Hand_GetData(data_serial_ptr, data_ptr) == FX_TRUE) ? 0 : -1);
}

int FX_L0_Arm1_Hand_SetData(unsigned char data_ptr[512])
{
    return ((RobotCtrl::Arm1_Hand_SetData(data_ptr) == FX_TRUE) ? 0 : -1);
}
...
int FX_L0_Arm0_Runtime_SetPDP(unsigned int thread_id, double p[7])
{
    return ((RobotCtrl::Arm0_Runtime_SetPDP(thread_id, p) == FX_TRUE) ? 0 : -1);
}

int FX_L0_Arm0_Runtime_SetPDD(unsigned int thread_id, double d[7])
{
    return ((RobotCtrl::Arm0_Runtime_SetPDD(thread_id, d) == FX_TRUE) ? 0 : -1);
}
...
int FX_L0_Arm0_Runtime_SetRefOri(unsigned int thread_id, int ref_ori_type, double ref_ori[3])
{
    return ((RobotCtrl::Arm0_Runtime_SetRefOri(thread_id, ref_ori_type, ref_ori) == FX_TRUE) ? 0 : -1);
}

int FX_L0_Arm0_Runtime_SetJointMITCmd(unsigned int thread_id, double pos_cmd[7], double vel_cmd[7], double tor_cmd[7], double k[7], double d[7])
{
    return ((RobotCtrl::Arm0_Runtime_SetJointMITCmd(thread_id, pos_cmd, vel_cmd, tor_cmd, k, d) == FX_TRUE) ? 0 : -1);
}
...
int FX_L0_Arm1_Runtime_SetPDP(unsigned int thread_id, double p[7])
{
    return ((RobotCtrl::Arm1_Runtime_SetPDP(thread_id, p) == FX_TRUE) ? 0 : -1);
}

int FX_L0_Arm1_Runtime_SetPDD(unsigned int thread_id, double d[7])
{
    return ((RobotCtrl::Arm1_Runtime_SetPDD(thread_id, d) == FX_TRUE) ? 0 : -1);
}
...
int FX_L0_Arm1_Runtime_SetRefOri(unsigned int thread_id, int ref_ori_type, double ref_ori[3])
{
    return ((RobotCtrl::Arm1_Runtime_SetRefOri(thread_id, ref_ori_type, ref_ori) == FX_TRUE) ? 0 : -1);
}

int FX_L0_Arm1_Runtime_SetJointMITCmd(unsigned int thread_id, double pos_cmd[7], double vel_cmd[7], double tor_cmd[7], double k[7], double d[7])
{
    return ((RobotCtrl::Arm1_Runtime_SetJointMITCmd(thread_id, pos_cmd, vel_cmd, tor_cmd, k, d) == FX_TRUE) ? 0 : -1);
}
