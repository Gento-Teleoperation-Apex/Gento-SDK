...
SDK_CPP="$SDK_DIR/FXUtility/FXMath/*.cpp $SDK_DIR/FXUtility/FXCfg/*.cpp $SDK_DIR/Interf/*.cpp $SDK_DIR/ToolDynaIdent/*.cpp $SDK_DIR/Kinematics/*.cpp $SDK_DIR/Kinematics/ArmKinematics/*.cpp $SDK_DIR/Kinematics/KineCommon/*.cpp $SDK_DIR/Kinematics/MotionPlanner/*.cpp $SDK_DIR/Kinematics/SkyeBodyKinematics/*.cpp $SDK_DIR/Kinematics/LunaBodyKinematics/*.cpp $SDK_DIR/FileClient/*.cpp $SDK_DIR/L0Control/*.cpp $SDK_DIR/L1Robot/*.cpp"

# SDK include dirs (same set as ../linux_auto_compile.sh).
INC_DIRS="-I$SDK_DIR/Common -I$SDK_DIR/FXUtility -I$SDK_DIR/FXUtility/FXMath -I$SDK_DIR/FXUtility/FXCfg -I$SDK_DIR/Interf -I$SDK_DIR/ToolDynaIdent -I$SDK_DIR/Kinematics -I$SDK_DIR/Kinematics/ArmKinematics -I$SDK_DIR/Kinematics/KineCommon -I$SDK_DIR/Kinematics/MotionPlanner -I$SDK_DIR/Kinematics/SkyeBodyKinematics -I$SDK_DIR/Kinematics/LunaBodyKinematics -I$SDK_DIR/FileClient -I$SDK_DIR/L0Control -I$SDK_DIR/L1Robot"
...
build_one() {
    ...
    echo "--------------------------------------------"
    g++ -std=gnu++17 -w "$SCRIPT_DIR/$n.cpp" $SDK_CPP $INC_DIRS -o "$SCRIPT_DIR/$n" -lrt -DCMPL_LIN -DL1_SDK_EXPORTS
