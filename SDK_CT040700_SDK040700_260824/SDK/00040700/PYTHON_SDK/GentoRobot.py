...
class GentoRobot:
    ...
    def _init_funcs(self):
        ...
        d.FX_Interf_CalcInterfDistance.argtypes = [c_void_p]
        d.FX_Interf_CalcInterfDistance.restype = c_int32

        d.FX_Interf_GetCoM.argtypes = [c_void_p, POINTER(c_double * 3)]
        d.FX_Interf_GetCoM.restype = c_int32

        d.FX_Interf_GetCordsNum.argtypes = [c_void_p, POINTER(c_long)]
        d.FX_Interf_GetCordsNum.restype = c_int32
    ...
    def set_system_sn(self, serial: str) -> int:
        ...
        return self.dll.FX_L1_System_SetSN(serial.encode('utf-8'))
    ...
    def interf_calc_interf_distance(self) -> int:
        ...
        """
        self._ensure_interf_handle()
        return self.dll.FX_Interf_CalcInterfDistance(self._interf_handle)
    ...
    def interf_get_cords_num(self) -> Tuple[int, int]:
        """Get the total count of loaded coordinate groups.

        @return: Tuple (return_code, cords_num).
        """
        self._ensure_interf_handle()
        n = c_long(0)
        ret = self.dll.FX_Interf_GetCordsNum(self._interf_handle, byref(n))
        return ret, n.value
    ...
    def interf_get_min_span(self) -> Tuple[int, float]:
        ...
        self._ensure_interf_handle()
        v = c_double(0)
        ret = self.dll.FX_Interf_GetMinSpan(self._interf_handle, byref(v))
        return ret, v.value
...
class RobotDataManager:
    """Background thread manager for continuously fetching RT, SG and HAND data."""
    ...
    def __init__(self, robot):
        ...
        self._hand_thread = threading.Thread(target=self._fetch_hand, daemon=True)
