...
from PYTHON_SDK.GentoRobot import GentoRobot, FXLogMask, FXObjMask, FXObjType,state_map,drag_type_map,error_dict, FXRefOriType
...
def main():
    ...
    default_ori=[0,0,0]
    ret=robot.switch_to_drag_cart_x(ctrl_obj,2000,FXRefOriType.FX_REFORI_TYPE_ANYBASE,default_ori,k,d)
    if ret !=0:
        print(f"Switch to {target_state} failed. Error msg: {robot._get_operate_error_msg(ret)}")
        return
