...
class FXUserFbkType:
    ...
    FX_USER_FBK_NULL = 0
    FX_USER_FBK_ARM0_CMD_FFDTOR = 100   # Arm0 FFD torque command (N*m)
    FX_USER_FBK_ARM1_CMD_FFDTOR = 200   # Arm1 FFD torque command (N*m)
    FX_USER_FBK_BODY_CMD_FFDTOR = 300   # Body FFD torque command (N*m)
...
class GentoRobot:
    ...
    def _init_funcs(self):
        ...
        d.FX_ToolDyn_Run_Load_Identification.argtypes = [POINTER(c_int32), POINTER(LoadDynamicPara), c_char_p]
    ...
    def system_set_user_fbk_type(self, chn_id: int, fbk_type: int) -> int:
        ...
        @param fbk_type: Source type (FXUserFbkType), e.g. FX_USER_FBK_ARM0_CMD_FFDTOR.
        @return: 0 on success, negative error code otherwise.
        """
    ...
    def run_load_identification(self, traj_file_path: str) -> Tuple[int, int, LoadDynamicPara]:
        ...
        path_arg = traj_file_path.encode('utf-8') if traj_file_path else None
        ret = self.dll.FX_ToolDyn_Run_Load_Identification(byref(error_code), byref(out_para), path_arg)
